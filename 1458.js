var regeneratorRuntime = require('regenerator-runtime'),
  ...
  p = (function () {
    function t(n) {
      ...
      this._pending = {};
      this._firestore = n;
      module1399.SharedEventEmitter.addListener(module1399.getAppEventName(this._firestore, 'firestore_transaction_event'), this._handleTransactionEvent.bind(this));
    }
    ...
    module25.default(t, [
      {
        ...
        value: function (t) {
          ...
          this._pending[s] = {
            meta: o,
            transaction: new module1459.default(this._firestore, o),
          };
          return new Promise(function (t, u) {
            module1404.getNativeModule(n._firestore).transactionBegin(s);
      ...
      },
      {
        key: '_remove',
        value: function (t) {
          module1404.getNativeModule(this._firestore).transactionDispose(t);
            ...
            function (b) {
              for (;;)
                switch ((b.prev = b.next)) {
                  ...
                  case 23:
                    f._pendingResult = v;
                    return b.abrupt('return', module1404.getNativeModule(this._firestore).transactionApplyBuffer(s, f._commandBuffer));
