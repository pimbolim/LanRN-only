var module1357 = require('./1357'),
  module1361 = require('./1361'),
  n = [].slice,
  h = ['keyword', 'gray', 'hex'],
  l = {};

Object.keys(module1361).forEach(function (t) {
  l[n.call(module1361[t].labels).sort().join('')] = t;
});
var s = {};

function c(u, f) {
  if (!(this instanceof c)) return new c(u, f);
  if ((f && f in h && (f = null), f && !(f in module1361))) throw new Error('Unknown model: ' + f);
  var v, p;
  ...
  if (null == u) {
    ...
    this.model = l[x];
    var j = module1361[this.model].labels,
      A = [];
  ...
  if (s[this.model])
    for (p = module1361[this.model].channels, v = 0; v < p; v++) {
...
function v(t, o, n) {
  (module1357 = Array.isArray(module1357) ? module1357 : [module1357]).forEach(function (t) {
    (s[t] || (s[t] = []))[o] = n;
  });
  module1357 = module1357[0];
  return function (h) {
    var l;

    if (arguments.length) {
      if (n) h = n(h);
      (l = this[module1357]()).color[o] = h;
      return l;
    } else {
      l = this[module1357]().color[o];
      if (n) l = n(l);
      return l;
    }
  };
...
c.prototype = {
  ...
  string: function (o) {
    var n = this.model in module1357.to ? this : this.rgb(),
      h = 1 === (n = n.round('number' == typeof o ? o : 1)).valpha ? n.color : n.color.concat(this.valpha);
    return module1357.to[n.model](h);
  },
  percentString: function (o) {
    var n = this.rgb().round('number' == typeof o ? o : 1),
      h = 1 === n.valpha ? n.color : n.color.concat(this.valpha);
    return module1357.to.rgb.percent(h);
  },
  array: function () {
    return 1 === this.valpha ? this.color.slice() : this.color.concat(this.valpha);
  },
  object: function () {
    for (var t = {}, n = module1361[this.model].channels, h = module1361[this.model].labels, l = 0; l < n; l++) t[h[l]] = this.color[l];
  ...
  round: function (t) {
    module1357 = (module1357 || 0) ** 0;
    return new c(this.color.map(f(module1357)).concat(this.valpha), this.model);
  },
  alpha: function (t) {
  ...
  b: v('lab', 2),
  keyword: function (t) {
    return arguments.length ? new c(t) : module1361[this.model].keyword(this.color);
  },
  hex: function (o) {
    return arguments.length ? new c(o) : module1357.to.hex(this.rgb().round().color);
  },
  rgbNumber: function () {
    var t = this.rgb().color;
...
Object.keys(module1361).forEach(function (t) {
  if (-1 === h.indexOf(t)) {
    ...
    c.prototype[t] = function () {
      ...
      return new c(((n = module1361[this.model][t].raw(this.color)), Array.isArray(n) ? n : [n]).concat(h), t);
    };
