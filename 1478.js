var module24 = require('./24'),
  ...
  u = (function () {
    function t(s, u, h) {
      if ((module24.default(this, t), !Object.values(module1477.Importance).includes(h))) throw new Error('AndroidChannel() Invalid Importance: ' + h);
      this._channelId = s;
      this._name = u;
      this._importance = h;
    }
    ...
    module25.default(t, [
      ...
      },
      {
        ...
        value: function (t) {
          if (!Object.values(module1477.Visibility).includes(t)) throw new Error('AndroidChannel:setLockScreenVisibility Invalid Visibility: ' + t);
