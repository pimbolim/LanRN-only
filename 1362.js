var module1363 = require('./1363'),
  t = {};

for (var h in module1363) module1363.hasOwnProperty(h) && (t[module1363[h]] = h);
...
u.rgb.keyword = function (h) {
  ...
  for (var b in module1363)
    if (module1363.hasOwnProperty(b)) {
      s = h;
      c = f;
      var f = module1363[b],
...
u.ansi256.rgb = function (n) {
  if (module1363 >= 232) {
    var t = 10 * (module1363 - 232) + 8;
    return [t, t, t];
  }

  var h;
  module1363 -= 16;
  return [(Math.floor(module1363 / 36) / 5) * 255, (Math.floor((h = module1363 % 36) / 6) / 5) * 255, ((h % 6) / 5) * 255];
};
