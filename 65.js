function l(l, n, o) {
  if (o < 0) o += 1;
  if (o > 1) o -= 1;
  return o < 0.16666666666666666 ? l + 6 * (n - l) * o : o < 0.5 ? n : o < 0.6666666666666666 ? l + (n - l) * (0.6666666666666666 - o) * 6 : l;
}

function n(n, o, t) {
  var u = t < 0.5 ? t * (1 + o) : t + o - t * o,
    s = 2 * t - u,
...
module.exports = function (l) {
  if (undefined === o)
    o = {
      rgb: new RegExp('rgb' + s(t, t, t)),
      rgba: new RegExp('rgba' + s(t, t, t, t)),
      hsl: new RegExp('hsl' + s(t, u, u)),
      hsla: new RegExp('hsla' + s(t, u, u, t)),
  ...
  if ('number' == typeof l) return l >>> 0 === l && l >= 0 && l <= 4294967295 ? l : null;
    ...
    return 'object' == typeof l && null != l && null != require('./66').normalizeColorObject(l)
      ? l
      : 'string' != typeof l
      ? null
      : (f = k.hex6.exec(l))
      ...
      : (f = k.rgba.exec(l))
      ? ((h(f[1]) << 24) | (h(f[2]) << 16) | (h(f[3]) << 8) | b(f[4])) >>> 0
      : (f = k.hex3.exec(l))
      ...
      : (f = k.hsl.exec(l))
      ? (255 | n(c(f[1]), p(f[2]), p(f[3]))) >>> 0
      : (f = k.hsla.exec(l))
      ? (n(c(f[1]), p(f[2]), p(f[3])) | b(f[4])) >>> 0
      : null;
};
