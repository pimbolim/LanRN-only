...
var s = {
  ...
  getItem: function (t, n) {
    return new Promise(function (s, c) {
      o(t);
      module454.default.multiGet([t], function (t, u) {
  ...
  setItem: function (t, n, s) {
    return new Promise(function (c, f) {
      o(t, n);
      module454.default.multiSet([[t, n]], function (t) {
        var n = l(t);
        if (s) s(n && n[0]);
        if (n) f(n[0]);
        else c(null);
  ...
  removeItem: function (t, n) {
    return new Promise(function (s, c) {
      o(t);
      module454.default.multiRemove([t], function (t) {
        var u = l(t);
        if (n) n(u && u[0]);
        if (u) c(u[0]);
        else s(null);
  ...
  mergeItem: function (t, n, s) {
    return new Promise(function (c, f) {
      o(t, n);
      module454.default.multiMerge([[t, n]], function (t) {
        var n = l(t);
        if (s) s(n && n[0]);
        if (n) f(n[0]);
        else c(null);
  ...
  clear: function (t) {
    return new Promise(function (n, o) {
      module454.default.clear(function (u) {
        var s = c(u);
        if (t) t(s);
        if (s) o(s);
        else n(null);
  ...
  getAllKeys: function (t) {
    return new Promise(function (n, o) {
      module454.default.getAllKeys(function (u, s) {
        var l = c(u);
        if (t) t(l, s);
        if (l) o(l);
        else n(s);
  ...
  flushGetRequests: function () {
    ...
    this._getRequests = [];
    this._getKeys = [];
    module454.default.multiGet(o, function (u, o) {
      var s = {};
      if (o)
  ...
  multiSet: function (t, s) {
    return new Promise(function (c, f) {
      ...
      module454.default.multiSet(t, function (t) {
        var n = l(t);
        if (s) s(n);
        if (n) f(n);
        else c(null);
  ...
  multiMerge: function (t, n) {
    return new Promise(function (o, s) {
      module454.default.multiMerge(t, function (t) {
        var u = l(t);
        if (n) n(u);
        if (u) s(u);
        else o(null);
...
if (!module454.default.multiMerge) {
  delete s.mergeItem;
  delete s.multiMerge;
}
