...
var module210 = require('./210'),
  ...
  C = {
    componentDidMount: function () {
      if (module49.isTV) {
        this._tvEventHandler = new module213();
    ...
    _remeasureMetricsOnActivation: function () {
      ...
      if (null != t) 'number' == typeof t ? module44.measure(t, this._handleQueryLayout) : t.measure(this._handleQueryLayout);
    },
    _handleQueryLayout: function (t, E, R, o, n, S) {
      if (t || E || R || o || n || S) {
        if (this.state.touchable.positionOnActivate) module212.release(this.state.touchable.positionOnActivate);
        if (this.state.touchable.dimensionsOnActivate) module210.release(this.state.touchable.dimensionsOnActivate);
        this.state.touchable.positionOnActivate = module212.getPooled(n, S);
        this.state.touchable.dimensionsOnActivate = module210.getPooled(R, o);
      }
    },
    ...
    _performSideEffectsForTransition: function (t, E, R, o) {
      ...
      if (
        ...
        if ((!A[t] || h) && this.touchableHandlePress) {
          ...
          if (!this.props.touchSoundDisabled) module215.playTouchSound();
  ...
  L = module53(C, ['touchableHandleFocus', 'touchableHandleBlur']);
