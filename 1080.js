...
function k(t) {
  ...
  return function () {
    ...
    if (n) {
      var h = module34.default(this).constructor;
      s = Reflect.construct(l, arguments, h);
    } else s = l.apply(this, arguments);

    return module37.default(this, s);
  };
}
...
exports.CALLBACK_TYPE = p;
var E = module25.default(function t() {
  ...
  W = (function (t) {
    ...
    module25.default(o, [
      ...
      },
      {
        key: 'initialize',
        value: function () {
          this.handlerTag = module966.getNextHandlerTag();
          this.handlers = y(
            y({}, this.handlers),
            {},
            {
      ...
      },
      {
        ...
        get: function () {
          return true !== this.config.runOnJS && !this.handlers.isWorklet.includes(false) && !module967.isRemoteDebuggingEnabled();
        },
      },
    ]);
    return o;
...
exports.ContinousBaseGesture = C;
