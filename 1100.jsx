...
var S = (function (t, ...args) {
  ...
  function O() {
    ...
    t.onHandlerStateChange = function (s) {
      ...
      if (o === module964.State.CANCELLED || o === module964.State.FAILED) t.moveToState(y.UNDETERMINED);
      else if (o === ('android' !== ReactNative.Platform.OS ? module964.State.ACTIVE : module964.State.BEGAN) && t.STATE === y.UNDETERMINED) t.handlePressIn();
      else if (o === module964.State.END) {
