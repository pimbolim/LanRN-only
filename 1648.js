var module47 = require('./47'),
  ...
  module34 = require('./34'),
  React = require('react'),
  module1623 = w(require('./1623')),
  module1630 = require('./1630'),
  module1646 = w(require('./1646')),
...
var M = (function (t, ...args) {
  ...
  function w() {
    ...
    (t = P.call(this, ...args)).setNativeProps = function (n) {
      ...
      module11.default(f, module1634.pickNotNil(module1646.default(f, false)));
  ...
  module25.default(w, [
    {
      ...
      value: function () {
        ...
        module11.default(n, module1646.default(t, false));
        n.ref = this.refMethod;
        return React.default.createElement(module1635.RNSVGTSpan, n);
      },
    },
  ]);
  return w;
