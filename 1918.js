...
var E = new module1914.default('XMLHttpRequest');
E.disable();
...
var R = 0,
  k = (function (t) {
    ...
    function S() {
      ...
      (t = T.call(this)).upload = new module1919.default();
      t._readyState = R;
      t._uriType = 'net';
      t._response = '';
      t._responseText = '';
      ...
      t._uploadProgressEvent = function (s, n) {
        ...
        t.upload.dispatchEvent('progress', new module1920.default(true, s, n));
      };
      ...
      t._progressEvent = function (s, n, o) {
        ...
        var u = false;
        if (n && n >= 0) u = true;
        var p = new module1920.default(u, s, n);
      ...
      t._onDone = function (s) {
        E.debug('XMLHttpRequest done', t._url, s, module39.default(t));
      ...
      [
        ...
        },
        {
          ...
          value: function (t, s, n, o, u) {
            ...
            this._url = s;
            this._headers = {};
            this._increment = module1915.default.isJSONStreamURI(this._url);
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (t instanceof module1913.default) {
              ...
              n = new Promise(function (n, o) {
                t.onCreated(function (o) {
                  ...
                  t = module1915.default.wrap(o.getReactNativeBlobUtilRef());
                  n();
                });
              });
...
exports.default = k;
k.binaryContentTypes = ['image/', 'video/', 'audio/'];
