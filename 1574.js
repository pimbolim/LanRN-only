...
exports.stackAnimatedStyles = function (t, p, o, u) {
  ...
  var f = function (t, n) {
      ...
      return ReactNative ? o - R - f : o + R + f;
    },
    s = 1 === o.inactiveSlideOpacity ? [1, 1, 1, 0] : [1, 0.75, 0.5, 0];

  return ReactNative
    ? {
        opacity: p.interpolate({
          inputRange: [-3, -2, -1, 0],
          outputRange: s.reverse(),
          extrapolate: 'clamp',
        }),
        transform: [
          {
...
exports.stackScrollInterpolator = function (t, n) {
  var p = ReactNative ? [1, 0, -1, -2, -3] : [3, 2, 1, 0, -1];
  return {
    inputRange: u(p, t, n),
    outputRange: p,
  };
