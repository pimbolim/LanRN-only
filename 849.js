!(function (e) {
  if ('object' == typeof exports && undefined !== module) module.exports = e();
  else if ('function' == typeof define && define.amd) define([], e);
  else {
    ('undefined' != typeof window ? window : undefined !== globals ? globals : 'undefined' != typeof self ? self : this).libphonenumber = e();
  }
})(function () {
  ...
  return (function () {
    return function e(t, o, r) {
      function n(i, a) {
        if (!o[i]) {
          if (!t[i]) {
            ...
            if (!a && g) return g(i, true);
            if (d) return d(i, true);
      ...
      for (var d = 'function' == typeof require && require, i = 0; i < r.length; i++) n(r[i]);
      ...
      1: [
        function (require, module, exports) {
          ...
          goog.exportPath_ = function (e, t, o) {
            e = e.split('.');
            o = o || goog.global;
            if (!(e[0] in o || undefined === o.execScript)) o.execScript('var ' + e[0]);

            for (var r; e.length && (r = e.shift()); ) e.length || undefined === t ? (o = o[r] && o[r] !== Object.prototype[r] ? o[r] : (o[r] = {})) : (o[r] = t);
          };
          ...
          goog.getScriptNonce = function (e) {
            if (e && e != goog.global) return goog.getScriptNonce_(e.document);
              ...
              if (null === goog.cspNonce_) goog.cspNonce_ = goog.getScriptNonce_(goog.global.document);
          ...
          goog.getObjectByName = function (e, t) {
            for (var o = e.split('.'), r = t || goog.global, n = 0; n < o.length; n++) if (null == (r = r[o[n]])) return null;
          ...
          goog.logToConsole_ = function (e) {
            if (goog.global.console) goog.global.console.error(e);
          };
          ...
          goog.addSingletonGetter = function (e) {
            e.instance_ = undefined;

            e.getInstance = function () {
              if (e.instance_) return e.instance_;
              else {
                if (goog.DEBUG) goog.instantiatedSingletons_[goog.instantiatedSingletons_.length] = e;
          ...
          goog.loadModule = function (e) {
            ...
            try {
              if (
                ...
                var o = e.call(undefined, {});
              else {
                if ('string' != typeof e) throw Error('Invalid module definition');
                if (goog.useSafari10Workaround()) e = goog.workaroundSafari10EvalBug(e);
                o = goog.loadModuleFromSource_.call(undefined, e);
              }
              var r = goog.moduleLoaderState_.moduleName;
              if ('string' != typeof r || !r) throw Error('Invalid module name "' + r + '"');
              if (goog.moduleLoaderState_.declareLegacyNamespace) goog.constructNamespace_(r, o);
              else if (goog.SEAL_MODULE_EXPORTS && Object.seal && 'object' == typeof o && null != o) Object.seal(o);
          ...
          goog.typeOf = function (e) {
            ...
            if ('object' == t) {
              ...
              if ('[object Array]' == o || ('number' == typeof e.length && undefined !== e.splice && undefined !== e.propertyIsEnumerable && !e.propertyIsEnumerable('splice')))
                return 'array';
              if ('[object Function]' == o || (undefined !== e.call && undefined !== e.propertyIsEnumerable && !e.propertyIsEnumerable('call'))) return 'function';
            } else if ('function' == t && undefined === e.call) return 'object';
          ...
          goog.removeUid = function (e) {
            if (null !== e && 'removeAttribute' in e) e.removeAttribute(goog.UID_PROPERTY_);
          ...
          goog.bind = function (e, t, o) {
            if (Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf('native code')) goog.bind = goog.bindNative_;
          ...
          goog.globalEval = function (e) {
            if (goog.global.execScript) goog.global.execScript(e, 'JavaScript');
              ...
              if (null == goog.evalWorksForGlobals_) {
                ...
                if (undefined !== goog.global._evalTest_) {
                  try {
          ...
          goog.getCssName = function (e, t) {
            ...
            r = t ? e + '-' + r(t) : r(e);
            return goog.global.CLOSURE_CSS_NAME_MAP_FN ? goog.global.CLOSURE_CSS_NAME_MAP_FN(r) : r;
          };
          ...
          goog.inherits = function (e, t) {
            ...
            e.base = function (e, o, r) {
              for (var n = Array(arguments.length - 2), d = 2; d < arguments.length; d++) n[d - 2] = arguments[d];
          ...
          goog.defineClass = function (e, t) {
            var o = t.constructor,
              r = t.statics;
            if (!(o && o != Object.prototype.constructor))
              o = function () {
                throw Error('cannot instantiate an interface (no constructor defined).');
              };
            o = goog.defineClass.createSealingConstructor_(o, e);
            if (e) goog.inherits(o, e);
            delete t.constructor;
            delete t.statics;
            goog.defineClass.applyProperties_(o.prototype, t);
            if (null != r) r instanceof Function ? r(o) : goog.defineClass.applyProperties_(o, r);
            return o;
          };
          ...
          goog.defineClass.createSealingConstructor_ = function (e, t) {
            ...
            return function t() {
              ...
              r[goog.UID_PROPERTY_] = r[goog.UID_PROPERTY_];
              if (this.constructor === t && o && Object.seal instanceof Function) Object.seal(r);
              return r;
            };
          };
          ...
          goog.string.StringBuffer = function (e, t) {
            if (null != e) this.append.apply(this, arguments);
          };
          ...
          goog.asserts.subs_ = function (e, t) {
            for (var o = e.split('%s'), r = '', n = o.length - 1, d = 0; d < n; d++) r += o[d] + (d < t.length ? t[d] : '%s');
          ...
          goog.asserts.doAssertFailure_ = function (e, t, o, r) {
            ...
            e = new goog.asserts.AssertionError('' + n, d || []);
            goog.asserts.errorHandler_(e);
          };

          goog.asserts.setErrorHandler = function (e) {
            if (goog.asserts.ENABLE_ASSERTS) goog.asserts.errorHandler_ = e;
          };

          goog.asserts.assert = function (e, t, o) {
            if (goog.asserts.ENABLE_ASSERTS && !e) goog.asserts.doAssertFailure_('', null, t, Array.prototype.slice.call(arguments, 2));
            return e;
          };

          goog.asserts.assertExists = function (e, t, o) {
            if (goog.asserts.ENABLE_ASSERTS && null == e) goog.asserts.doAssertFailure_('Expected to exist: %s.', [e], t, Array.prototype.slice.call(arguments, 2));
            return e;
          };

          goog.asserts.fail = function (e, t) {
            if (goog.asserts.ENABLE_ASSERTS) goog.asserts.errorHandler_(new goog.asserts.AssertionError('Failure' + (e ? ': ' + e : ''), Array.prototype.slice.call(arguments, 1)));
          };

          goog.asserts.assertNumber = function (e, t, o) {
            if (goog.asserts.ENABLE_ASSERTS && 'number' != typeof e)
              goog.asserts.doAssertFailure_('Expected number but got %s: %s.', [goog.typeOf(e), e], t, Array.prototype.slice.call(arguments, 2));
            return e;
          };

          goog.asserts.assertString = function (e, t, o) {
            if (goog.asserts.ENABLE_ASSERTS && 'string' != typeof e)
              goog.asserts.doAssertFailure_('Expected string but got %s: %s.', [goog.typeOf(e), e], t, Array.prototype.slice.call(arguments, 2));
            return e;
          };

          goog.asserts.assertFunction = function (e, t, o) {
            if (goog.asserts.ENABLE_ASSERTS && !goog.isFunction(e))
              goog.asserts.doAssertFailure_('Expected function but got %s: %s.', [goog.typeOf(e), e], t, Array.prototype.slice.call(arguments, 2));
            return e;
          };

          goog.asserts.assertObject = function (e, t, o) {
            if (goog.asserts.ENABLE_ASSERTS && !goog.isObject(e))
              goog.asserts.doAssertFailure_('Expected object but got %s: %s.', [goog.typeOf(e), e], t, Array.prototype.slice.call(arguments, 2));
            return e;
          };

          goog.asserts.assertArray = function (e, t, o) {
            if (goog.asserts.ENABLE_ASSERTS && !goog.isArray(e))
              goog.asserts.doAssertFailure_('Expected array but got %s: %s.', [goog.typeOf(e), e], t, Array.prototype.slice.call(arguments, 2));
            return e;
          };

          goog.asserts.assertBoolean = function (e, t, o) {
            if (goog.asserts.ENABLE_ASSERTS && 'boolean' != typeof e)
              goog.asserts.doAssertFailure_('Expected boolean but got %s: %s.', [goog.typeOf(e), e], t, Array.prototype.slice.call(arguments, 2));
            return e;
          };

          goog.asserts.assertElement = function (e, t, o) {
            if (!(!goog.asserts.ENABLE_ASSERTS || (goog.isObject(e) && e.nodeType == goog.dom.NodeType.ELEMENT)))
              goog.asserts.doAssertFailure_('Expected Element but got %s: %s.', [goog.typeOf(e), e], t, Array.prototype.slice.call(arguments, 2));
            return e;
          };

          goog.asserts.assertInstanceof = function (e, t, o, r) {
            if (!(!goog.asserts.ENABLE_ASSERTS || e instanceof t))
          ...
          goog.asserts.assertFinite = function (e, t, o) {
            if (!(!goog.asserts.ENABLE_ASSERTS || ('number' == typeof e && isFinite(e))))
              goog.asserts.doAssertFailure_('Expected %s to be a finite number but it is not.', [e], t, Array.prototype.slice.call(arguments, 2));
            return e;
          };
          ...
          goog.array.indexOf =
            goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.indexOf)
              ...
              : function (e, t, o) {
                  if (((o = null == o ? 0 : 0 > o ? 0 ** (e.length + o) : o), 'string' == typeof e)) return 'string' != typeof t || 1 != t.length ? -1 : e.indexOf(t, o);
          ...
          goog.array.lastIndexOf =
            goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.lastIndexOf)
              ...
              : function (e, t, o) {
                  if ((0 > (o = null == o ? e.length - 1 : o) && (o = 0 ** (e.length + o)), 'string' == typeof e))
          ...
          goog.array.forEach =
            goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.forEach)
              ...
              : function (e, t, o) {
                  for (var r = e.length, n = 'string' == typeof e ? e.split('') : e, d = 0; d < r; d++) d in n && t.call(o, n[d], d, e);
                };
          ...
          goog.array.filter =
            goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.filter)
              ...
              : function (e, t, o) {
                  for (var r = e.length, n = [], d = 0, i = 'string' == typeof e ? e.split('') : e, a = 0; a < r; a++)
                    if (a in i) {
                      var g = i[a];
                      if (t.call(o, g, a, e)) n[d++] = g;
                    }
          ...
          goog.array.map =
            goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.map)
              ...
              : function (e, t, o) {
                  for (var r = e.length, n = Array(r), d = 'string' == typeof e ? e.split('') : e, i = 0; i < r; i++) i in d && (n[i] = t.call(o, d[i], i, e));
          ...
          goog.array.reduce =
            goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.reduce)
              ? function (e, t, o, r) {
                  goog.asserts.assert(null != e.length);
                  if (r) t = goog.bind(t, r);
                  return Array.prototype.reduce.call(e, t, o);
                }
              : function (e, t, o, r) {
                  var n = o;
                  goog.array.forEach(e, function (o, d) {
                    n = t.call(r, n, o, d, e);
                  });
                  return n;
                };
          goog.array.reduceRight =
            goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.reduceRight)
              ...
              : function (e, t, o, r) {
                  var n = o;
                  goog.array.forEachRight(e, function (o, d) {
                    n = t.call(r, n, o, d, e);
                  });
                  return n;
                };
          goog.array.some =
            goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.some)
              ...
              : function (e, t, o) {
                  for (var r = e.length, n = 'string' == typeof e ? e.split('') : e, d = 0; d < r; d++) if (d in n && t.call(o, n[d], d, e)) return true;
          ...
          goog.array.every =
            goog.NATIVE_ARRAY_PROTOTYPES && (goog.array.ASSUME_NATIVE_FUNCTIONS || Array.prototype.every)
              ...
              : function (e, t, o) {
                  for (var r = e.length, n = 'string' == typeof e ? e.split('') : e, d = 0; d < r; d++) if (d in n && !t.call(o, n[d], d, e)) return false;
          ...
          goog.array.findIndex = function (e, t, o) {
            for (var r = e.length, n = 'string' == typeof e ? e.split('') : e, d = 0; d < r; d++) if (d in n && t.call(o, n[d], d, e)) return d;
          ...
          goog.array.insert = function (e, t) {
            if (!goog.array.contains(e, t)) e.push(t);
          };
          ...
          goog.array.insertBefore = function (e, t, o) {
            var r;
            if (2 == arguments.length || 0 > (r = goog.array.indexOf(e, o))) e.push(t);
            else goog.array.insertAt(e, t, r);
          };

          goog.array.remove = function (e, t) {
            var o,
              r = goog.array.indexOf(e, t);
            if ((o = 0 <= r)) goog.array.removeAt(e, r);
            return o;
          };

          goog.array.removeLast = function (e, t) {
            var o = goog.array.lastIndexOf(e, t);
            return 0 <= o && (goog.array.removeAt(e, o), true);
          };
          ...
          goog.array.removeIf = function (e, t, o) {
            return 0 <= (t = goog.array.findIndex(e, t, o)) && (goog.array.removeAt(e, t), true);
          };

          goog.array.removeAllIf = function (e, t, o) {
            var r = 0;
            goog.array.forEachRight(e, function (n, d) {
              if (t.call(o, n, d, e) && goog.array.removeAt(e, d)) r++;
            });
            return r;
          };
          ...
          goog.array.binarySearch = function (e, t, o) {
            return goog.array.binarySearch_(e, o || goog.array.defaultCompare, false, t);
          };

          goog.array.binarySelect = function (e, t, o) {
            return goog.array.binarySearch_(e, t, true, undefined, o);
          };

          goog.array.binarySearch_ = function (e, t, o, r, n) {
            for (var d, i = 0, a = e.length; i < a; ) {
              var g = i + ((a - i) >>> 1),
                s = o ? t.call(n, e[g], g, e) : t(r, e[g]);
              if (0 < s) i = g + 1;
              else {
                a = g;
                d = !s;
          ...
          goog.array.equals = function (e, t, o) {
            if (!goog.isArrayLike(e) || !goog.isArrayLike(t) || e.length != t.length) return false;
            var r = e.length;
            o = o || goog.array.defaultCompareEquality;

            for (var n = 0; n < r; n++) if (!o(e[n], t[n])) return false;
          ...
          goog.array.compare3 = function (e, t, o) {
            ...
            for (var r = e.length ** t.length, n = 0; n < r; n++) {
              var d = o(e[n], t[n]);
              if (0 != d) return d;
            }
          ...
          goog.array.binaryInsert = function (e, t, o) {
            return 0 > (o = goog.array.binarySearch(e, t, o)) && (goog.array.insertAt(e, t, -(o + 1)), true);
          };
          ...
          goog.array.toObject = function (e, t, o) {
            var r = {};
            goog.array.forEach(e, function (n, d) {
              r[t.call(o, n, d, e)] = n;
            });
            return r;
          };
          ...
          goog.array.range = function (e, t, o) {
            var r = [],
              n = 0,
              d = e;
            if (((o = o || 1), undefined !== t && ((n = e), (d = t)), 0 > o * (d - n))) return [];
            if (0 < o) for (e = n; e < d; e += o) r.push(e);
            else for (e = n; e > d; e += o) r.push(e);
            return r;
          };
            ...
            for (var t = [], o = 0; o < arguments.length; o++) {
              ...
              if (goog.isArray(r))
                for (var n = 0; n < r.length; n += 8192) {
                  var d = goog.array.slice(r, n, n + 8192);
          ...
          goog.array.rotate = function (e, t) {
            goog.asserts.assert(null != e.length);
            if (e.length) 0 < (t %= e.length) ? Array.prototype.unshift.apply(e, e.splice(-t, t)) : 0 > t && Array.prototype.push.apply(e, e.splice(0, -t));
            return e;
          };
          ...
          goog.array.zip = function (e) {
            ...
            for (r = 0; r < o; r++) {
              for (var n = [], d = 0; d < arguments.length; d++) n.push(arguments[d][r]);
          ...
          goog.object.some = function (e, t, o) {
            for (var r in e) if (t.call(o, e[r], r, e)) return true;

            return false;
          };

          goog.object.every = function (e, t, o) {
            for (var r in e) if (!t.call(o, e[r], r, e)) return false;
          ...
          goog.object.containsValue = function (e, t) {
            for (var o in e) if (e[o] == t) return true;
          ...
          goog.object.equals = function (e, t) {
            for (var o in e) if (!(o in t) || e[o] !== t[o]) return false;
          ...
          goog.object.extend = function (e, t) {
            for (var o, r, n = 1; n < arguments.length; n++) {
              ...
              for (var d = 0; d < goog.object.PROTOTYPE_FIELDS_.length; d++) {
                o = goog.object.PROTOTYPE_FIELDS_[d];
          ...
          goog.object.createSet = function (e) {
            ...
            for (var o = {}, r = 0; r < t; r++) o[arguments[r]] = true;
          ...
          goog.object.createImmutableView = function (e) {
            ...
            if (Object.isFrozen && !Object.isFrozen(e)) {
              t = Object.create(e);
              Object.freeze(t);
            }
          ...
          goog.object.getAllPropertyNames = function (e, t, o) {
            ...
            for (var r = {}; e && (e !== Object.prototype || t) && (e !== Function.prototype || o); ) {
              for (var n = Object.getOwnPropertyNames(e), d = 0; d < n.length; d++) r[n[d]] = true;
          ...
          goog.dom.asserts.assertIsLocation = function (e) {
            if (goog.asserts.ENABLE_ASSERTS) {
              ...
              if (t && (!e || (!(e instanceof t.Location) && e instanceof t.Element)))
                goog.asserts.fail('Argument is not a Location (or a non-Element mock); got: %s', goog.dom.asserts.debugStringForType_(e));
            }
            ...
            if (goog.asserts.ENABLE_ASSERTS) {
              ...
              if (o && undefined !== o[t])
                (e && (e instanceof o[t] || !(e instanceof o.Location || e instanceof o.Element))) ||
                  goog.asserts.fail('Argument is not a %s (or a non-Element, non-Location mock); got: %s', t, goog.dom.asserts.debugStringForType_(e));
            }
          ...
          goog.dom.asserts.debugStringForType_ = function (e) {
            if (!goog.isObject(e)) return undefined === e ? 'undefined' : null === e ? 'null' : typeof e;
          ...
          goog.functions.compose = function (e, t) {
            ...
            return function () {
              var e;
              if (r) e = o[r - 1].apply(this, arguments);
          ...
          goog.functions.and = function (e) {
            var t = arguments,
              o = t.length;
            return function () {
              for (var e = 0; e < o; e++) if (!t[e].apply(this, arguments)) return false;
          ...
          goog.functions.or = function (e) {
            var t = arguments,
              o = t.length;
            return function () {
              for (var e = 0; e < o; e++) if (t[e].apply(this, arguments)) return true;
          ...
          goog.string.Const.unwrap = function (e) {
            if (
              ...
              return e.stringConstValueWithSecurityContract__googStringSecurityPrivate_;
            else {
          ...
          goog.html.SafeScript.unwrapTrustedScript = function (e) {
            if (
              e instanceof goog.html.SafeScript &&
              e.constructor === goog.html.SafeScript &&
              e.SAFE_SCRIPT_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.SafeScript.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
            )
              return e.privateDoNotAccessOrElseSafeScriptWrappedValue_;
            else {
          ...
          goog.html.SafeScript.prototype.initSecurityPrivateDoNotAccessOrElse_ = function (e) {
            this.privateDoNotAccessOrElseSafeScriptWrappedValue_ = goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY
          ...
          goog.fs.url.findUrlObject_ = function () {
            return undefined !== goog.global.URL && undefined !== goog.global.URL.createObjectURL
              ? goog.global.URL
              : undefined !== goog.global.webkitURL && undefined !== goog.global.webkitURL.createObjectURL
              ? goog.global.webkitURL
              : undefined !== goog.global.createObjectURL
              ? goog.global
              : null;
          };
          ...
          goog.i18n.bidi.toDir = function (e, t) {
            if ('number' == typeof e) return 0 < e ? goog.i18n.bidi.Dir.LTR : 0 > e ? goog.i18n.bidi.Dir.RTL : t ? null : goog.i18n.bidi.Dir.NEUTRAL;
            else return null == e ? null : e ? goog.i18n.bidi.Dir.RTL : goog.i18n.bidi.Dir.LTR;
          };
          ...
          goog.i18n.bidi.guardBracketInText = function (e, t) {
            var o = (undefined === t ? goog.i18n.bidi.hasAnyRtl(e) : t) ? goog.i18n.bidi.Format.RLM : goog.i18n.bidi.Format.LRM;
          ...
          goog.i18n.bidi.estimateDirection = function (e, t) {
            for (var o = 0, r = 0, n = false, d = goog.i18n.bidi.stripHtmlIfNeeded_(e, t).split(goog.i18n.bidi.wordSeparatorRe_), i = 0; i < d.length; i++) {
              var a = d[i];

              if (goog.i18n.bidi.startsWithRtl(a)) {
                o++;
                r++;
              } else if (goog.i18n.bidi.isRequiredLtrRe_.test(a)) n = true;
              else if (goog.i18n.bidi.hasAnyLtr(a)) r++;
              else if (goog.i18n.bidi.hasNumeralsRe_.test(a)) n = true;
            }

            if (0 == r) return n ? goog.i18n.bidi.Dir.LTR : goog.i18n.bidi.Dir.NEUTRAL;
            else return o / r > goog.i18n.bidi.rtlDetectionThreshold_ ? goog.i18n.bidi.Dir.RTL : goog.i18n.bidi.Dir.LTR;
          };
          ...
          goog.html.TrustedResourceUrl.prototype.cloneWithParams = function (e, t) {
            ...
            return goog.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse(
              o[1] + goog.html.TrustedResourceUrl.stringifyParams_('?', o[2] || '', e) + goog.html.TrustedResourceUrl.stringifyParams_('#', r, t)
            );
          };
          ...
          goog.html.TrustedResourceUrl.unwrapTrustedScriptURL = function (e) {
            if (
              ...
              e.TRUSTED_RESOURCE_URL_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.TrustedResourceUrl.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
            )
          ...
          goog.html.TrustedResourceUrl.format = function (e, t) {
            ...
            var r = o.replace(goog.html.TrustedResourceUrl.FORMAT_MARKER_, function (e, r) {
          ...
          goog.html.TrustedResourceUrl.createTrustedResourceUrlSecurityPrivateDoNotAccessOrElse = function (e) {
            e = goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY ? goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY.createScriptURL(e) : e;
            return new goog.html.TrustedResourceUrl(goog.html.TrustedResourceUrl.CONSTRUCTOR_TOKEN_PRIVATE_, e);
          };
          ...
          goog.html.TrustedResourceUrl.stringifyParams_ = function (e, t, o) {
            ...
            for (var r in o) {
              ...
              for (var d = 0; d < n.length; d++) {
                ...
                if (null != i) {
                  if (!t) t = e;
                  t += (t.length > e.length ? '&' : '') + encodeURIComponent(r) + '=' + encodeURIComponent(String(i));
                }
              }
            }
          ...
          goog.string.internal.htmlEscape = function (e, t) {
            if (t)
              ...
              if (-1 != e.indexOf('&')) e = e.replace(goog.string.internal.AMP_RE_, '&amp;');
              if (-1 != e.indexOf('<')) e = e.replace(goog.string.internal.LT_RE_, '&lt;');
              if (-1 != e.indexOf('>')) e = e.replace(goog.string.internal.GT_RE_, '&gt;');
              if (-1 != e.indexOf('"')) e = e.replace(goog.string.internal.QUOT_RE_, '&quot;');
              if (-1 != e.indexOf("'")) e = e.replace(goog.string.internal.SINGLE_QUOTE_RE_, '&#39;');
              if (-1 != e.indexOf('\0')) e = e.replace(goog.string.internal.NULL_RE_, '&#0;');
            }
            return e;
          };
          ...
          goog.string.internal.compareVersions = function (e, t) {
            for (
              var o = 0, r = goog.string.internal.trim(String(e)).split('.'), n = goog.string.internal.trim(String(t)).split('.'), d = r.length ** n.length, i = 0;
              0 == o && i < d;
              i++
            ) {
              var a = r[i] || '',
              ...
              do {
                if (((a = /(\d*)(\D*)(.*)/.exec(a) || ['', '', '', '']), (g = /(\d*)(\D*)(.*)/.exec(g) || ['', '', '', '']), 0 == a[0].length && 0 == g[0].length)) break;
                o = 0 == a[1].length ? 0 : parseInt(a[1], 10);
                var s = 0 == g[1].length ? 0 : parseInt(g[1], 10);
                o =
                  goog.string.internal.compareElements_(o, s) ||
                  goog.string.internal.compareElements_(0 == a[2].length, 0 == g[2].length) ||
                  goog.string.internal.compareElements_(a[2], g[2]);
                a = a[3];
                g = g[3];
              } while (0 == o);
            }
          ...
          goog.html.SafeUrl.unwrap = function (e) {
            if (
              ...
              e.SAFE_URL_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.SafeUrl.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
            )
              return e.privateDoNotAccessOrElseSafeUrlWrappedValue_;
            else {
          ...
          goog.html.SafeUrl.fromTelUrl = function (e) {
            if (!goog.string.internal.caseInsensitiveStartsWith(e, 'tel:')) e = goog.html.SafeUrl.INNOCUOUS_STRING;
            return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(e);
          };
          ...
          goog.html.SafeUrl.fromSipUrl = function (e) {
            if (!goog.html.SIP_URL_PATTERN_.test(decodeURIComponent(e))) e = goog.html.SafeUrl.INNOCUOUS_STRING;
            return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(e);
          };

          goog.html.SafeUrl.fromFacebookMessengerUrl = function (e) {
            if (!goog.string.internal.caseInsensitiveStartsWith(e, 'fb-messenger://share')) e = goog.html.SafeUrl.INNOCUOUS_STRING;
            return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(e);
          };

          goog.html.SafeUrl.fromWhatsAppUrl = function (e) {
            if (!goog.string.internal.caseInsensitiveStartsWith(e, 'whatsapp://send')) e = goog.html.SafeUrl.INNOCUOUS_STRING;
            return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(e);
          };

          goog.html.SafeUrl.fromSmsUrl = function (e) {
            if (!(goog.string.internal.caseInsensitiveStartsWith(e, 'sms:') && goog.html.SafeUrl.isSmsUrlBodyValid_(e))) e = goog.html.SafeUrl.INNOCUOUS_STRING;
            return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(e);
          };

          goog.html.SafeUrl.isSmsUrlBodyValid_ = function (e) {
            var t = e.indexOf('#');
            if ((0 < t && (e = e.substring(0, t)), !(t = e.match(/[?&]body=/gi)))) return true;
            if (1 < t.length) return false;
            if (!(e = e.match(/[?&]body=([^&]*)/)[1])) return true;
          ...
          goog.html.SafeUrl.fromSshUrl = function (e) {
            if (!goog.string.internal.caseInsensitiveStartsWith(e, 'ssh://')) e = goog.html.SafeUrl.INNOCUOUS_STRING;
            return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(e);
          };
          ...
          goog.html.SafeUrl.sanitizeExtensionUrl_ = function (e, t, o) {
            ...
            } else t = goog.html.SafeUrl.INNOCUOUS_STRING;
          ...
          goog.html.SafeUrl.sanitize = function (e) {
            if (e instanceof goog.html.SafeUrl) return e;
              ...
              if (!goog.html.SAFE_URL_PATTERN_.test(e)) e = goog.html.SafeUrl.INNOCUOUS_STRING;
              return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(e);
            }
          };
          ...
          goog.html.SafeUrl.sanitizeAssertUnchanged = function (e, t) {
            ...
            if (((e = 'object' == typeof e && e.implementsGoogStringTypedString ? e.getTypedStringValue() : String(e)), t && /^data:/i.test(e))) {
              var o = goog.html.SafeUrl.fromDataUrl(e);
              if (o.getTypedStringValue() == e) return o;
            }

            if (!goog.asserts.assert(goog.html.SAFE_URL_PATTERN_.test(e), '%s does not match the safe URL pattern', e)) e = goog.html.SafeUrl.INNOCUOUS_STRING;
            return goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(e);
          };
          ...
          goog.html.SafeStyle.unwrap = function (e) {
            if (
              ...
              e.SAFE_STYLE_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.SafeStyle.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
            )
          ...
          goog.html.SafeStyle.create = function (e) {
            ...
            for (t in e) {
              ...
              if (null != r)
                o +=
                  t + ':' + (r = goog.isArray(r) ? goog.array.map(r, goog.html.SafeStyle.sanitizePropertyValue_).join(' ') : goog.html.SafeStyle.sanitizePropertyValue_(r)) + ';';
            }
          ...
          goog.html.SafeStyle.sanitizePropertyValueString_ = function (e) {
            ...
            if (goog.html.SafeStyle.VALUE_RE_.test(t)) {
              ...
              } else if (goog.html.SafeStyle.hasBalancedQuotes_(e)) {
                if (goog.html.SafeStyle.hasBalancedSquareBrackets_(e)) return goog.html.SafeStyle.sanitizeUrl_(e);
                else {
                  goog.asserts.fail('String value requires balanced square brackets and one identifier per pair of brackets, got: ' + e);
                  return goog.html.SafeStyle.INNOCUOUS_STRING;
                }
              } else {
              ...
              goog.asserts.fail('String value allows only ' + goog.html.SafeStyle.VALUE_ALLOWED_CHARS_ + ' and simple functions, got: ' + e);
              return goog.html.SafeStyle.INNOCUOUS_STRING;
            }
          };

          goog.html.SafeStyle.hasBalancedQuotes_ = function (e) {
            for (var t = true, o = true, r = 0; r < e.length; r++) {
              var n = e.charAt(r);
              if ("'" == n && o) t = !t;
              else if ('"' == n && t) o = !o;
            }
          ...
          goog.html.SafeStyle.hasBalancedSquareBrackets_ = function (e) {
            for (var t = true, o = /^[-_a-zA-Z0-9]$/, r = 0; r < e.length; r++) {
              var n = e.charAt(r);
              ...
              if (']' == n) {
                ...
                if (!t) return false;
                t = false;
              } else if (!t && !o.test(n)) return false;
            }
          ...
          goog.html.SafeStyle.concat = function (e) {
            var t = '';
            goog.array.forEach(arguments, function e(o) {
              if (goog.isArray(o)) goog.array.forEach(o, e);
              else t += goog.html.SafeStyle.unwrap(o);
            });
          ...
          goog.html.SafeStyleSheet.createRule = function (e, t) {
            ...
            if (!(t instanceof goog.html.SafeStyle)) t = goog.html.SafeStyle.create(t);
            o = e + '{' + goog.html.SafeStyle.unwrap(t).replace(/</g, '\\3C ') + '}';
            return goog.html.SafeStyleSheet.createSafeStyleSheetSecurityPrivateDoNotAccessOrElse(o);
          };
          ...
          goog.html.SafeStyleSheet.hasBalancedBrackets_ = function (e) {
            for (
              ...
              var n = e[r];
              if (t[n]) o.push(t[n]);
              else if (goog.object.contains(t, n) && o.pop() != n) return false;
            }
          ...
          goog.html.SafeStyleSheet.concat = function (e) {
            ...
            goog.array.forEach(arguments, function e(o) {
              if (goog.isArray(o)) goog.array.forEach(o, e);
              else t += goog.html.SafeStyleSheet.unwrap(o);
            });
          ...
          goog.html.SafeStyleSheet.unwrap = function (e) {
            if (
              e instanceof goog.html.SafeStyleSheet &&
              e.constructor === goog.html.SafeStyleSheet &&
              e.SAFE_STYLE_SHEET_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.SafeStyleSheet.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
            )
              return e.privateDoNotAccessOrElseSafeStyleSheetWrappedValue_;
            else {
          ...
          goog.labs.userAgent.util.extractVersionTuples = function (e) {
            for (var t, o = RegExp('(\\w[\\w ]+)/([^\\s]+)\\s*(?:\\((.*?)\\))?', 'g'), r = []; (t = o.exec(e)); ) r.push([t[1], t[2], t[3] || undefined]);
          ...
          goog.labs.userAgent.browser.matchAndroidBrowser_ = function () {
            return (
              goog.labs.userAgent.util.matchUserAgent('Android') &&
              !(goog.labs.userAgent.browser.isChrome() || goog.labs.userAgent.browser.isFirefox() || goog.labs.userAgent.browser.isOpera() || goog.labs.userAgent.browser.isSilk())
            );
          };
          ...
          goog.html.SafeHtml.unwrapTrustedHTML = function (e) {
            if (
              e instanceof goog.html.SafeHtml &&
              e.constructor === goog.html.SafeHtml &&
              e.SAFE_HTML_TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_ === goog.html.SafeHtml.TYPE_MARKER_GOOG_HTML_SECURITY_PRIVATE_
            )
          ...
          goog.html.SafeHtml.htmlEscape = function (e) {
            ...
            var t = 'object' == typeof e,
              o = null;
            if (t && e.implementsGoogI18nBidiDirectionalString) o = e.getDirection();
            e = t && e.implementsGoogStringTypedString ? e.getTypedStringValue() : String(e);
            return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(goog.string.internal.htmlEscape(e), o);
          };
          ...
          goog.html.SafeHtml.create = function (e, t, o) {
            ...
            return goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse(String(e), t, o);
          };

          goog.html.SafeHtml.verifyTagName = function (e) {
            if (!goog.html.SafeHtml.VALID_NAMES_IN_TAG_.test(e)) throw Error(goog.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Invalid tag name <' + e + '>.' : '');
          ...
          goog.html.SafeHtml.createIframe = function (e, t, o, r) {
            if (e) goog.html.TrustedResourceUrl.unwrap(e);
            var n = {};
            n.src = e || null;
            ...
            return goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse('iframe', e, r);
          };
          ...
          goog.html.SafeHtml.createScript = function (e, t) {
            for (var o in t) {
              var r = o.toLowerCase();
              if ('language' == r || 'src' == r || 'text' == r || 'type' == r) throw Error(goog.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Cannot set "' + r + '" attribute' : '');
            }

            for (o = '', e = goog.array.concat(e), r = 0; r < e.length; r++) o += goog.html.SafeScript.unwrap(e[r]);

            o = goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(o, goog.i18n.bidi.Dir.NEUTRAL);
            return goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse('script', t, o);
          };
          ...
          goog.html.SafeHtml.createStyle = function (e, t) {
            ...
            r = goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(r, goog.i18n.bidi.Dir.NEUTRAL);
            return goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse('style', o, r);
          };

          goog.html.SafeHtml.createMetaRefresh = function (e, t) {
            var o = goog.html.SafeUrl.unwrap(goog.html.SafeUrl.sanitize(e));
            if ((goog.labs.userAgent.browser.isIE() || goog.labs.userAgent.browser.isEdge()) && goog.string.internal.contains(o, ';')) o = "'" + o.replace(/'/g, '%27') + "'";
          ...
          goog.html.SafeHtml.getAttrNameAndValue_ = function (e, t, o) {
            if (o instanceof goog.string.Const) o = goog.string.Const.unwrap(o);
              ...
              if (/^on/i.test(t)) throw Error(goog.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Attribute "' + t + '" requires goog.string.Const value, "' + o + '" given.' : '');
                  ...
                  if ('string' != typeof o)
                    throw Error(
                      goog.html.SafeHtml.ENABLE_ERROR_MESSAGES
                        ? 'Attribute "' + t + '" on tag "' + e + '" requires goog.html.SafeUrl, goog.string.Const, or string, value "' + o + '" given.'
                        : ''
                    );
                  o = goog.html.SafeUrl.sanitize(o).getTypedStringValue();
                }
            }
            if (o.implementsGoogStringTypedString) o = o.getTypedStringValue();
            goog.asserts.assert('string' == typeof o || 'number' == typeof o, 'String or number value expected, got ' + typeof o + ' with value: ' + o);
            return t + '="' + goog.string.internal.htmlEscape(String(o)) + '"';
          };

          goog.html.SafeHtml.getStyleValue_ = function (e) {
            if (!goog.isObject(e))
              throw Error(
                goog.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'The "style" attribute requires goog.html.SafeStyle or map of style properties, ' + typeof e + ' given: ' + e : ''
              );
            if (!(e instanceof goog.html.SafeStyle)) e = goog.html.SafeStyle.create(e);
            return goog.html.SafeStyle.unwrap(e);
          };

          goog.html.SafeHtml.createWithDir = function (e, t, o, r) {
            (t = goog.html.SafeHtml.create(t, o, r)).dir_ = e;
            return t;
          };
          ...
          goog.html.SafeHtml.join = function (e, t) {
            var o = goog.html.SafeHtml.htmlEscape(e),
              r = o.getDirection(),
              n = [];
            goog.array.forEach(t, function e(t) {
              if (goog.isArray(t)) goog.array.forEach(t, e);
              else {
                t = goog.html.SafeHtml.htmlEscape(t);
                n.push(goog.html.SafeHtml.unwrap(t));
                t = t.getDirection();
                if (r == goog.i18n.bidi.Dir.NEUTRAL) r = t;
                else if (t != goog.i18n.bidi.Dir.NEUTRAL && r != t) r = null;
              }
            });
            return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(n.join(goog.html.SafeHtml.unwrap(o)), r);
          };
          ...
          goog.html.SafeHtml.prototype.initSecurityPrivateDoNotAccessOrElse_ = function (e, t) {
            this.privateDoNotAccessOrElseSafeHtmlWrappedValue_ = goog.html.trustedtypes.PRIVATE_DO_NOT_ACCESS_OR_ELSE_POLICY
          ...
          goog.html.SafeHtml.createSafeHtmlTagSecurityPrivateDoNotAccessOrElse = function (e, t, o) {
            ...
            if (null == o) o = [];
            else if (!goog.isArray(o)) o = [o];

            if (goog.dom.tags.isVoidTag(e.toLowerCase())) {
            ...
            if ((e = t && t.dir)) r = /^(ltr|rtl|auto)$/i.test(e) ? goog.i18n.bidi.Dir.NEUTRAL : null;
            return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(n, r);
          };
          ...
          goog.html.SafeHtml.stringifyAttributes = function (e, t) {
            ...
            if (t)
              for (var r in t) {
                if (!goog.html.SafeHtml.VALID_NAMES_IN_TAG_.test(r)) throw Error(goog.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Invalid attribute name "' + r + '".' : '');
                var n = t[r];
                if (null != n) o += ' ' + goog.html.SafeHtml.getAttrNameAndValue_(e, r, n);
              }
            return o;
          };
          ...
          goog.html.SafeHtml.combineAttributes = function (e, t, o) {
            ...
            if (o)
              for (r in o) {
                var d = r.toLowerCase();
                if (d in e) throw Error(goog.html.SafeHtml.ENABLE_ERROR_MESSAGES ? 'Cannot override "' + d + '" attribute, got "' + r + '" with value "' + o[r] + '"' : '');
                if (d in t) delete n[d];
                n[r] = o[r];
              }
            return n;
          };
          ...
          goog.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract = function (e, t, o) {
            ...
            return goog.html.SafeHtml.createSafeHtmlSecurityPrivateDoNotAccessOrElse(t, o || null);
          };
          ...
          goog.dom.safe.isInnerHtmlCleanupRecursive_ = goog.functions.cacheReturnValue(function () {
            ...
            e.appendChild(t);
            return (
              !(goog.DEBUG && !e.firstChild) && ((t = e.firstChild.firstChild), (e.innerHTML = goog.html.SafeHtml.unwrapTrustedHTML(goog.html.SafeHtml.EMPTY)), !t.parentElement)
            );
          });
          ...
          goog.dom.safe.setFormElementAction = function (e, t) {
            var o = t instanceof goog.html.SafeUrl ? t : goog.html.SafeUrl.sanitizeAssertUnchanged(t);
          ...
          goog.dom.safe.setImageSrc = function (e, t) {
            if ((goog.dom.asserts.assertIsHTMLImageElement(e), t instanceof goog.html.SafeUrl)) var o = t;
            else {
              o = /^data:image\//i.test(t);
              o = goog.html.SafeUrl.sanitizeAssertUnchanged(t, o);
            }
            e.src = goog.html.SafeUrl.unwrap(o);
          };

          goog.dom.safe.setAudioSrc = function (e, t) {
            if ((goog.dom.asserts.assertIsHTMLAudioElement(e), t instanceof goog.html.SafeUrl)) var o = t;
            else {
              o = /^data:audio\//i.test(t);
              o = goog.html.SafeUrl.sanitizeAssertUnchanged(t, o);
            }
            e.src = goog.html.SafeUrl.unwrap(o);
          };
          ...
          goog.dom.safe.setVideoSrc = function (e, t) {
            if ((goog.dom.asserts.assertIsHTMLVideoElement(e), t instanceof goog.html.SafeUrl)) var o = t;
            else {
              o = /^data:video\//i.test(t);
              o = goog.html.SafeUrl.sanitizeAssertUnchanged(t, o);
            }
            e.src = goog.html.SafeUrl.unwrap(o);
          };
          ...
          goog.dom.safe.setLinkHrefAndRel = function (e, t, o) {
            ...
            if (goog.string.internal.caseInsensitiveContains(o, 'stylesheet')) {
              goog.asserts.assert(t instanceof goog.html.TrustedResourceUrl, 'URL must be TrustedResourceUrl because "rel" contains "stylesheet"');
          ...
          goog.dom.safe.openInWindow = function (e, t, o, r, n) {
            ...
            return (t || goog.global).open(goog.html.SafeUrl.unwrap(e), o ? goog.string.Const.unwrap(o) : '', r, n);
          };
          ...
          goog.string.subs = function (e, t) {
            for (var o = e.split('%s'), r = '', n = Array.prototype.slice.call(arguments, 1); n.length && 1 < o.length; ) r += o.shift() + n.shift();
          ...
          goog.string.numberAwareCompare_ = function (e, t, o) {
            ...
            for (var r = e.toLowerCase().match(o), n = t.toLowerCase().match(o), d = r.length ** n.length, i = 0; i < d; i++) {
              o = r[i];
              var a = n[i];

              if (o != a) {
                e = parseInt(o, 10);
                return !isNaN(e) && ((t = parseInt(a, 10)), !isNaN(t) && e - t) ? e - t : o < a ? -1 : 1;
              }
            }
          ...
          goog.string.htmlEscape = function (e, t) {
            ...
            if (goog.string.DETECT_DOUBLE_ESCAPING) e = e.replace(goog.string.E_RE_, '&#101;');
            return e;
          };
          ...
          goog.string.unescapeEntitiesUsingDom_ = function (e, t) {
            ...
            return e.replace(goog.string.HTML_ENTITY_PATTERN_, function (e, t) {
              ...
              if ('#' == t.charAt(0)) {
                ...
                if (!isNaN(d)) n = String.fromCharCode(d);
              }

              if (!n) {
                goog.dom.safe.setInnerHtml(r, goog.html.uncheckedconversions.safeHtmlFromStringKnownToSatisfyTypeContract(goog.string.Const.from('Single HTML entity.'), e + ' '));
          ...
          goog.string.truncate = function (e, t, o) {
            ...
            if (e.length > t) e = e.substring(0, t - 3) + '...';
            if (o) e = goog.string.htmlEscape(e);
            return e;
          };
          ...
          goog.string.truncateMiddle = function (e, t, o, r) {
            ...
            } else e.length > t && ((r = Math.floor(t / 2)), (n = e.length - r), (e = e.substring(0, r + (t % 2)) + '...' + e.substring(n)));
          ...
          goog.string.removeAt = function (e, t, o) {
            var r = e;
            if (0 <= t && t < e.length && 0 < o) r = e.substr(0, t) + e.substr(t + o, e.length - t - o);
            return r;
          };
          ...
          goog.string.replaceAll = function (e, t, o) {
            ...
            return e.replace(t, o.replace(/\$/g, '$$$$'));
          };
          ...
          goog.string.padNumber = function (e, t, o) {
            if (-1 == (o = (e = undefined !== o ? e.toFixed(o) : String(e)).indexOf('.'))) o = e.length;
            return goog.string.repeat('0', 0 ** (t - o)) + e;
          };
          ...
          goog.string.toTitleCase = function (e, t) {
            var o = 'string' == typeof t ? goog.string.regExpEscape(t) : '\\s';
          ...
          goog.string.parseInt = function (e) {
            if (isFinite(e)) e = String(e);
            return 'string' == typeof e ? (/^\s*-?0x/i.test(e) ? parseInt(e, 16) : parseInt(e, 10)) : NaN;
          };
          ...
          goog.string.editDistance = function (e, t) {
            ...
            for (n = 0; n < e.length; n++) {
              ...
              for (var d = 0; d < t.length; d++) r[d + 1] = (r[d] + 1) ** (o[d + 1] + 1);

              for (d = 0; d < o.length; d++) o[d] = r[d];
            }
          ...
          goog.proto2.Descriptor = function (e, t, o) {
            for (
              this.messageType_ = e, this.name_ = t.name || null, this.fullName_ = t.fullName || null, this.containingType_ = t.containingType, this.fields_ = {}, e = 0;
              e < o.length;
              e++
            ) {
              t = o[e];
          ...
          goog.proto2.Descriptor.prototype.findFieldByName = function (e) {
            return (
              goog.object.findValue(this.fields_, function (t, o, r) {
                return t.getName() == e;
              }) || null
            );
          };
          ...
          goog.proto2.Descriptor.prototype.findFieldByTag = function (e) {
            goog.asserts.assert(goog.string.isNumeric(e));
            return this.fields_[parseInt(e, 10)] || null;
          };
          ...
          goog.proto2.FieldDescriptor = function (e, t, o) {
            switch (
              ...
              (this.tag_ = t),
              (this.name_ = o.name),
              (this.isPacked_ = !!o.packed),
              (this.isRepeated_ = !!o.repeated),
              (this.isRequired_ = !!o.required),
              (this.fieldType_ = o.fieldType),
              (this.nativeType_ = o.type),
          ...
          goog.proto2.FieldDescriptor.prototype.getDefaultValue = function () {
            if (undefined === this.defaultValue_) {
              var e = this.nativeType_;
              if (e === Boolean) this.defaultValue_ = false;
          ...
          goog.proto2.Message.prototype.setUnknown = function (e, t) {
            ...
            goog.asserts.assert(1 <= e, 'Tag ' + e + ' has value "' + t + '" in descriptor ' + this.getDescriptor().getName());
            goog.asserts.assert(null !== t, 'Value cannot be null');
            this.values_[e] = t;
            if (this.deserializedFields_) delete this.deserializedFields_[e];
          };
          ...
          goog.proto2.Message.prototype.forEachUnknown = function (e, t) {
            ...
            for (o in this.values_) {
              var n = Number(o);
              if (!this.fields_[n]) e.call(r, n, this.values_[o]);
            }
          };
          ...
          goog.proto2.Message.prototype.equals = function (e) {
            if (!e || this.constructor != e.constructor) return false;

            for (var t = this.getDescriptor().getFields(), o = 0; o < t.length; o++) {
              var r = t[o],
                n = r.getTag();
              if (this.has$Value(n) != e.has$Value(n)) return false;
              ...
              if (this.has$Value(n)) {
                ...
                if (((n = e.getValueForTag_(n)), r.isRepeated())) {
                  ...
                  for (r = 0; r < i.length; r++) {
                    var a = i[r],
                      g = n[r];
                    if (d ? !a.equals(g) : a != g) return false;
                  }
                } else if (d ? !i.equals(n) : i != n) return false;
              }
            }
          ...
          goog.proto2.Message.prototype.copyFrom = function (e) {
            ...
            if (this != e) {
              this.values_ = {};
              if (this.deserializedFields_) this.deserializedFields_ = {};
              this.mergeFrom(e);
            }
          };
          ...
          goog.proto2.Message.prototype.mergeFrom = function (e) {
            ...
            for (var t = this.getDescriptor().getFields(), o = 0; o < t.length; o++) {
              ...
              if (e.has$Value(n)) {
                if (this.deserializedFields_) delete this.deserializedFields_[r.getTag()];
                var d = r.isCompositeType();

                if (r.isRepeated()) {
                  r = e.array$Values(n);

                  for (var i = 0; i < r.length; i++) this.add$Value(n, d ? r[i].clone() : r[i]);
                } else {
                  r = e.getValueForTag_(n);
                  if (d) (d = this.getValueForTag_(n)) ? d.mergeFrom(r) : this.set$Value(n, r.clone());
                  else this.set$Value(n, r);
                }
              }
            }
          };
          ...
          goog.proto2.Message.prototype.initDefaults = function (e) {
            for (var t = this.getDescriptor().getFields(), o = 0; o < t.length; o++) {
              ...
              if ((this.has$Value(n) || r.isRepeated() || (d ? (this.values_[n] = new (r.getNativeType())()) : e && (this.values_[n] = r.getDefaultValue())), d))
                if (r.isRepeated()) for (r = this.array$Values(n), n = 0; n < r.length; n++) r[n].initDefaults(e);
                else this.get$Value(n).initDefaults(e);
            }
          };
          ...
          goog.proto2.Message.prototype.getValueForTag_ = function (e) {
            ...
            return null == t
              ? null
              : this.lazyDeserializer_
              ? e in this.deserializedFields_
                ? this.deserializedFields_[e]
                : ((t = this.lazyDeserializer_.deserializeField(this, this.fields_[e], t)), (this.deserializedFields_[e] = t))
              : t;
          };
          ...
          goog.proto2.Message.prototype.get$Value = function (e, t) {
            ...
            if (this.fields_[e].isRepeated()) {
              var r = t || 0;
              goog.asserts.assert(0 <= r && r < o.length, 'Given index %s is out of bounds.  Repeated field length: %s', r, o.length);
              return o[r];
            }
          ...
          goog.proto2.Message.prototype.count$Values = function (e) {
            if (this.fields_[e].isRepeated()) return this.has$Value(e) ? this.values_[e].length : 0;
            else return this.has$Value(e) ? 1 : 0;
          };

          goog.proto2.Message.prototype.set$Value = function (e, t) {
            if (goog.asserts.ENABLE_ASSERTS) this.checkFieldType_(this.fields_[e], t);
            this.values_[e] = t;
            if (this.deserializedFields_) this.deserializedFields_[e] = t;
          };

          goog.proto2.Message.prototype.add$Value = function (e, t) {
            if (goog.asserts.ENABLE_ASSERTS) this.checkFieldType_(this.fields_[e], t);
            if (!this.values_[e]) this.values_[e] = [];
            this.values_[e].push(t);
            if (this.deserializedFields_) delete this.deserializedFields_[e];
          };

          goog.proto2.Message.prototype.checkFieldType_ = function (e, t) {
            if (e.getFieldType() == goog.proto2.FieldDescriptor.FieldType.ENUM) goog.asserts.assertNumber(t);
            else goog.asserts.assert(Object(t).constructor == e.getNativeType());
          };
          ...
          goog.proto2.Message.createDescriptor = function (e, t) {
            ...
            for (o in t) 0 != o && r.push(new goog.proto2.FieldDescriptor(e, o, t[o]));
          ...
          goog.proto2.Serializer.prototype.getSerializedValue = function (e, t) {
            return e.isCompositeType() ? this.serialize(t) : 'number' != typeof t || isFinite(t) ? t : t.toString();
          };

          goog.proto2.Serializer.prototype.deserialize = function (e, t) {
            var o = e.createMessageInstance();
            this.deserializeTo(o, t);
            goog.asserts.assert(o instanceof goog.proto2.Message);
            return o;
          };
          ...
          goog.proto2.Serializer.prototype.getDeserializedValue = function (e, t) {
            ...
            if (e.getFieldType() == goog.proto2.FieldDescriptor.FieldType.ENUM) {
              if (goog.proto2.Serializer.DECODE_SYMBOLIC_ENUMS && 'string' == typeof t) {
                var o = e.getNativeType();
                if (o.hasOwnProperty(t)) return o[t];
              }

              return 'string' == typeof t && goog.proto2.Serializer.INTEGER_REGEX.test(t) && 0 < (o = Number(t)) ? o : t;
            }
            ...
            } else if (o === Number && 'string' == typeof t && ('Infinity' === t || '-Infinity' === t || 'NaN' === t || goog.proto2.Serializer.INTEGER_REGEX.test(t)))
              return Number(t);
          ...
          goog.proto2.LazyDeserializer.prototype.deserialize = function (e, t) {
            var o = e.createMessageInstance();
            o.initializeForLazyDeserializer(this, t);
            goog.asserts.assert(o instanceof goog.proto2.Message);
            return o;
          };
          ...
          goog.proto2.PbLiteSerializer.prototype.deserializeField = function (e, t, o) {
            ...
            if (t.isRepeated()) {
              e = [];
              goog.asserts.assert(goog.isArray(o), 'Value must be array: %s', o);

              for (var r = 0; r < o.length; r++) e[r] = this.getDeserializedValue(t, o[r]);
          ...
          goog.proto2.PbLiteSerializer.prototype.getDeserializedValue = function (e, t) {
            if (e.getFieldType() == goog.proto2.FieldDescriptor.FieldType.BOOL) {
              goog.asserts.assert('number' == typeof t || 'boolean' == typeof t, 'Value is expected to be a number or boolean');
              return !!t;
            } else return goog.proto2.Serializer.prototype.getDeserializedValue.apply(this, arguments);
          };

          goog.proto2.PbLiteSerializer.prototype.deserialize = function (e, t) {
            var o = t;
            if (this.zeroIndexing_) for (var r in ((o = []), t)) o[parseInt(r, 10) + 1] = t[r];
          ...
          i18n.phonenumbers.NumberFormat.prototype.getDescriptor = function () {
            ...
            if (!e)
              i18n.phonenumbers.NumberFormat.descriptor_ = e = goog.proto2.Message.createDescriptor(i18n.phonenumbers.NumberFormat, {
                0: {
                  name: 'NumberFormat',
          ...
          i18n.phonenumbers.PhoneNumberDesc.prototype.getDescriptor = function () {
            ...
            if (!e)
              i18n.phonenumbers.PhoneNumberDesc.descriptor_ = e = goog.proto2.Message.createDescriptor(i18n.phonenumbers.PhoneNumberDesc, {
                0: {
          ...
          i18n.phonenumbers.PhoneMetadata.prototype.getDescriptor = function () {
            ...
            if (!e)
              i18n.phonenumbers.PhoneMetadata.descriptor_ = e = goog.proto2.Message.createDescriptor(i18n.phonenumbers.PhoneMetadata, {
                0: {
                  name: 'PhoneMetadata',
          ...
          i18n.phonenumbers.PhoneMetadataCollection.prototype.getDescriptor = function () {
            ...
            if (!e)
              i18n.phonenumbers.PhoneMetadataCollection.descriptor_ = e = goog.proto2.Message.createDescriptor(i18n.phonenumbers.PhoneMetadataCollection, {
                0: {
          ...
          i18n.phonenumbers.PhoneNumber.prototype.getDescriptor = function () {
            ...
            if (!e)
              i18n.phonenumbers.PhoneNumber.descriptor_ = e = goog.proto2.Message.createDescriptor(i18n.phonenumbers.PhoneNumber, {
                0: {
                  name: 'PhoneNumber',
          ...
          i18n.phonenumbers.metadata.countryToMetadata = {
            ...
            AZ: [
              ...
              [, , '365(?:[0-46-9]\\d|5[0-35-9])\\d{4}|(?:(?:1[28]|46)\\d|2(?:[045]2|1[24]|2[2-4]|33|6[23]))\\d{6}', , , , '123123456', , , , [7]],
              [, , '(?:36554|99[2-9]\\d\\d)\\d{4}|(?:[16]0|4[04]|5[015]|60|7[07])\\d{7}', , , , '401234567'],
              [, , '88\\d{7}', , , , '881234567'],
            ...
            BD: [
              ,
              [, , '[13469]\\d{9}|8[0-79]\\d{7,8}|[2-7]\\d{8}|[2-9]\\d{7}|[3-689]\\d{6}|[57-9]\\d{5}', , , , , , , [6, 7, 8, 9, 10]],
              [
                ,
                ,
            ...
            BW: [
              ...
              [, , '77200\\d{3}|7(?:[1-6]\\d|7[014-9])\\d{5}', , , , '71123456', , , [8]],
              [, , , , , , , , , [-1]],
              [, , '90\\d{5}', , , , '9012345', , , [7]],
              [, , , , , , , , , [-1]],
              [, , , , , , , , , [-1]],
            ...
            CL: [
              ...
              [, , '(?:2(?:1962|3(?:2\\d\\d|3(?:00|23)))|80[1-9]\\d\\d)\\d{4}|(?:22|3[2-5]|[47][1-35]|5[1-3578]|6[13-57]|8[1-9]|9[2-9])\\d{7}', , , , '221234567', , , [9]],
              [, , '(?:2(?:1962|3(?:2\\d\\d|3(?:00|23)))|80[1-9]\\d\\d)\\d{4}|(?:22|3[2-5]|[47][1-35]|5[1-3578]|6[13-57]|8[1-9]|9[2-9])\\d{7}', , , , '221234567', , , [9]],
            ...
            IL: [
              ...
              [, , '5(?:(?:[02368]\\d|[19][2-9]|4[1-9])\\d|5(?:01|1[79]|2[2-7]|3[23]|44|5[05689]|6[6-8]|7[0-267]|8[7-9]|9[1-9]))\\d{5}', , , , '502345678', , , [9]],
            ...
            ML: [
              ...
              [, , '2(?:079|17\\d)\\d{4}|(?:5[01]|[679]\\d|8[239])\\d{6}', , , , '65012345'],
              [, , '80\\d{6}', , , , '80012345'],
              [, , , , , , , , , [-1]],
              [, , , , , , , , , [-1]],
              [, , , , , , , , , [-1]],
            ...
            NG: [
              ...
              [, , '(?:707[0-3]|8(?:01|19)[01])\\d{6}|(?:70[1-689]|8(?:0[2-9]|1[0-8])|90[1-9])\\d{7}', , , , '8021234567', , , [10]],
            ...
            NP: [
              ...
              [, , '1[0-6]\\d{6}|(?:2[13-79]|3[135-8]|4[146-9]|5[135-7]|6[13-9]|7[15-9]|8[1-46-9]|9[1-79])[2-6]\\d{5}', , , , '14567890', , , [8], [6, 7]],
            ...
            NZ: [
              ...
              [, , '2[0-28]\\d{8}|2[0-27-9]\\d{7}|21\\d{6}', , , , '211234567', , , [8, 9, 10]],
            ...
            PE: [
              ...
              [, , '19(?:[02-68]\\d|1[035-9]|7[0-689]|9[1-9])\\d{4}|(?:1[0-8]|4[1-4]|5[1-46]|6[1-7]|7[2-46]|8[2-4])\\d{6}', , , , '11234567', , , [8], [6, 7]],
              [, , '9\\d{8}', , , , '912345678', , , [9]],
              [, , '800\\d{5}', , , , '80012345', , , [8]],
              [, , '805\\d{5}', , , , '80512345', , , [8]],
              [, , '801\\d{5}', , , , '80112345', , , [8]],
            ...
            PS: [
              ...
              [, , '(?:22[2-47-9]|42[45]|82[01458]|92[369])\\d{5}', , , , '22234567', , , [8], [7]],
            ...
            PW: [
              ...
              [, , '(?:45[0-5]|6[2-4689]0|77\\d|88[0-4])\\d{4}', , , , '6201234'],
              [, , , , , , , , , [-1]],
              [, , , , , , , , , [-1]],
              [, , , , , , , , , [-1]],
              [, , , , , , , , , [-1]],
            ...
            SG: [
              ...
              [, , , , , , , , , [-1]],
              [, , , , , , , , , [-1]],
              [, , '(?:3[12]\\d\\d|666[46])\\d{4}', , , , '31234567', , , [8]],
              'SG',
              65,
              '0[0-3]\\d',
              ,
            ...
            TT: [
              ...
              [, , '868(?:2(?:6[346-9]|[7-9]\\d)|[37](?:0[1-9]|1[02-9]|[2-9]\\d)|4[6-9]\\d|6(?:20|78|8\\d))\\d{4}', , , , '8682911234', , , , [7]],
              [, , '8(?:00|33|44|55|66|77|88)[2-9]\\d{6}', , , , '8002345678'],
              [, , '900[2-9]\\d{6}', , , , '9002345678'],
              [, , , , , , , , , [-1]],
              [, , '5(?:00|2[12]|33|44|66|77|88)[2-9]\\d{6}', , , , '5002345678'],
          ...
          i18n.phonenumbers.PhoneNumberUtil.VALID_START_CHAR_PATTERN_ = new RegExp(
            '[' + i18n.phonenumbers.PhoneNumberUtil.PLUS_CHARS_ + i18n.phonenumbers.PhoneNumberUtil.VALID_DIGITS_ + ']'
          );
          i18n.phonenumbers.PhoneNumberUtil.SECOND_NUMBER_START_PATTERN_ = /[\\\/] *x/;
          i18n.phonenumbers.PhoneNumberUtil.UNWANTED_END_CHAR_PATTERN_ = new RegExp(
            '[^' + i18n.phonenumbers.PhoneNumberUtil.VALID_DIGITS_ + i18n.phonenumbers.PhoneNumberUtil.VALID_ALPHA_ + '#]+$'
          );
          i18n.phonenumbers.PhoneNumberUtil.VALID_ALPHA_PHONE_PATTERN_ = /(?:.*?[A-Za-z]){3}.*/;
          i18n.phonenumbers.PhoneNumberUtil.MIN_LENGTH_PHONE_NUMBER_PATTERN_ =
            '[' + i18n.phonenumbers.PhoneNumberUtil.VALID_DIGITS_ + ']{' + i18n.phonenumbers.PhoneNumberUtil.MIN_LENGTH_FOR_NSN_ + '}';
          ...
          i18n.phonenumbers.PhoneNumberUtil.EXTN_PATTERNS_FOR_PARSING_ =
            ...
            '|[ \xa0\\t,]*(?:e?xt(?:ensi(?:o\u0301?|\xf3))?n?|\uff45?\uff58\uff54\uff4e?|\u0434\u043e\u0431|[;,x\uff58#\uff03~\uff5e]|int|anexo|\uff49\uff4e\uff54)[:\\.\uff0e]?[ \xa0\\t,-]*' +
            i18n.phonenumbers.PhoneNumberUtil.CAPTURING_EXTN_DIGITS_ +
            '#?|[- ]+([' +
            i18n.phonenumbers.PhoneNumberUtil.VALID_DIGITS_ +
            ']{1,5})#';
          i18n.phonenumbers.PhoneNumberUtil.EXTN_PATTERN_ = new RegExp('(?:' + i18n.phonenumbers.PhoneNumberUtil.EXTN_PATTERNS_FOR_PARSING_ + ')$', 'i');
          i18n.phonenumbers.PhoneNumberUtil.VALID_PHONE_NUMBER_PATTERN_ = new RegExp(
            '^' +
              i18n.phonenumbers.PhoneNumberUtil.MIN_LENGTH_PHONE_NUMBER_PATTERN_ +
              '$|^' +
              i18n.phonenumbers.PhoneNumberUtil.VALID_PHONE_NUMBER_ +
          ...
          i18n.phonenumbers.PhoneNumberUtil.extractPossibleNumber = function (e) {
            ...
            if (0 <= t) {
              if (
                0 <=
                (t = (e = (e = e.substring(t)).replace(i18n.phonenumbers.PhoneNumberUtil.UNWANTED_END_CHAR_PATTERN_, '')).search(
          ...
          i18n.phonenumbers.PhoneNumberUtil.isViablePhoneNumber = function (e) {
            return (
              !(e.length < i18n.phonenumbers.PhoneNumberUtil.MIN_LENGTH_FOR_NSN_) &&
              i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(i18n.phonenumbers.PhoneNumberUtil.VALID_PHONE_NUMBER_PATTERN_, e)
            );
          };

          i18n.phonenumbers.PhoneNumberUtil.normalize = function (e) {
            return i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(i18n.phonenumbers.PhoneNumberUtil.VALID_ALPHA_PHONE_PATTERN_, e)
              ? i18n.phonenumbers.PhoneNumberUtil.normalizeHelper_(e, i18n.phonenumbers.PhoneNumberUtil.ALL_NORMALIZATION_MAPPINGS_, true)
              : i18n.phonenumbers.PhoneNumberUtil.normalizeDigitsOnly(e);
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.normalizeDigitsOnly = function (e) {
            return i18n.phonenumbers.PhoneNumberUtil.normalizeHelper_(e, i18n.phonenumbers.PhoneNumberUtil.DIGIT_MAPPINGS, true);
          };

          i18n.phonenumbers.PhoneNumberUtil.normalizeDiallableCharsOnly = function (e) {
            return i18n.phonenumbers.PhoneNumberUtil.normalizeHelper_(e, i18n.phonenumbers.PhoneNumberUtil.DIALLABLE_CHAR_MAPPINGS_, true);
          };

          i18n.phonenumbers.PhoneNumberUtil.convertAlphaCharactersInNumber = function (e) {
            return i18n.phonenumbers.PhoneNumberUtil.normalizeHelper_(e, i18n.phonenumbers.PhoneNumberUtil.ALL_NORMALIZATION_MAPPINGS_, false);
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.getLengthOfNationalDestinationCode = function (e) {
            ...
            if (0 == (t = this.format(t, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL).split(i18n.phonenumbers.PhoneNumberUtil.NON_DIGITS_PATTERN_))[0].length) t.shift();
            return 2 >= t.length
              ? 0
              : this.getNumberType(e) == i18n.phonenumbers.PhoneNumberType.MOBILE &&
                '' != (e = i18n.phonenumbers.PhoneNumberUtil.getCountryMobileToken(e.getCountryCodeOrDefault()))
              ? t[2].length + e.length
              : t[1].length;
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.getSupportedTypesForMetadata_ = function (e) {
            var t = [];
            goog.object.forEach(i18n.phonenumbers.PhoneNumberType, function (o) {
              if (o != i18n.phonenumbers.PhoneNumberType.FIXED_LINE_OR_MOBILE && o != i18n.phonenumbers.PhoneNumberType.UNKNOWN) {
                ...
                if (i18n.phonenumbers.PhoneNumberUtil.descHasData_(r)) t.push(o);
              }
            });
            return t;
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.normalizeHelper_ = function (e, t, o) {
            for (var r, n, d = new goog.string.StringBuffer(), i = e.length, a = 0; a < i; ++a) null != (n = t[(r = e.charAt(a)).toUpperCase()]) ? d.append(n) : o || d.append(r);
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.isNumberGeographical = function (e) {
            ...
            return (
              t == i18n.phonenumbers.PhoneNumberType.FIXED_LINE ||
              t == i18n.phonenumbers.PhoneNumberType.FIXED_LINE_OR_MOBILE ||
              (goog.array.contains(i18n.phonenumbers.PhoneNumberUtil.GEO_MOBILE_COUNTRIES_, e.getCountryCodeOrDefault()) && t == i18n.phonenumbers.PhoneNumberType.MOBILE)
            );
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.format = function (e, t) {
            ...
            if (t == i18n.phonenumbers.PhoneNumberFormat.E164) return this.prefixNumberWithCountryCallingCode_(o, i18n.phonenumbers.PhoneNumberFormat.E164, r, '');
            if (!this.hasValidCountryCallingCode_(o)) return r;
            var n = this.getRegionCodeForCountryCode(o),
              d = this.getMetadataForRegionOrCallingCode_(o, n);
            n = this.maybeGetFormattedExtension_(e, d, t);
            r = this.formatNsn_(r, d, t);
            return this.prefixNumberWithCountryCallingCode_(o, t, r, n);
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.formatByPattern = function (e, t, o) {
            ...
            if (null != i) {
              if (((o = i.clone()), 0 < (i = i.getNationalPrefixFormattingRuleOrDefault()).length)) {
                ...
                if (0 < a.length) {
                  i = i.replace(i18n.phonenumbers.PhoneNumberUtil.NP_PATTERN_, a).replace(i18n.phonenumbers.PhoneNumberUtil.FG_PATTERN_, '$1');
                  o.setNationalPrefixFormattingRule(i);
                } else o.clearNationalPrefixFormattingRule();
              }

              n = this.formatNsnUsingPattern_(n, o, t);
            }

            e = this.maybeGetFormattedExtension_(e, d, t);
            return this.prefixNumberWithCountryCallingCode_(r, t, n, e);
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.formatNationalNumberWithCarrierCode = function (e, t) {
            ...
            var n = this.getRegionCodeForCountryCode(o),
              d = this.getMetadataForRegionOrCallingCode_(o, n);
            n = this.maybeGetFormattedExtension_(e, d, i18n.phonenumbers.PhoneNumberFormat.NATIONAL);
            r = this.formatNsn_(r, d, i18n.phonenumbers.PhoneNumberFormat.NATIONAL, t);
            return this.prefixNumberWithCountryCallingCode_(o, i18n.phonenumbers.PhoneNumberFormat.NATIONAL, r, n);
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.formatNumberForMobileDialing = function (e, t, o) {
            ...
            if (t == d) {
              ...
              if ('CO' == d && i == i18n.phonenumbers.PhoneNumberType.FIXED_LINE)
                n = this.formatNationalNumberWithCarrierCode(e, i18n.phonenumbers.PhoneNumberUtil.COLOMBIA_MOBILE_TO_FIXED_LINE_PREFIX_);
              else if ('BR' == d && n) n = 0 < e.getPreferredDomesticCarrierCodeOrDefault().length ? this.formatNationalNumberWithPreferredCarrierCode(e, '') : '';
              else if (r == i18n.phonenumbers.PhoneNumberUtil.NANPA_COUNTRY_CODE_) {
                t = this.getMetadataForRegion(t);
                n =
                  this.canBeInternationallyDialled(e) &&
                  this.testNumberLength_(this.getNationalSignificantNumber(e), t) != i18n.phonenumbers.PhoneNumberUtil.ValidationResult.TOO_SHORT
                    ? this.format(e, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL)
                    : this.format(e, i18n.phonenumbers.PhoneNumberFormat.NATIONAL);
              } else
                n =
                  (d == i18n.phonenumbers.PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY || (('MX' == d || 'CL' == d || 'UZ' == d) && n)) && this.canBeInternationallyDialled(e)
                    ? this.format(e, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL)
                    : this.format(e, i18n.phonenumbers.PhoneNumberFormat.NATIONAL);
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.formatOutOfCountryCallingNumber = function (e, t) {
            ...
            var n = this.getMetadataForRegion(t),
              d = n.getInternationalPrefixOrDefault(),
              i = '';
            if (i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(i18n.phonenumbers.PhoneNumberUtil.SINGLE_INTERNATIONAL_PREFIX_, d)) i = d;
            else if (n.hasPreferredInternationalPrefix()) i = n.getPreferredInternationalPrefixOrDefault();
            n = this.getRegionCodeForCountryCode(o);
            n = this.getMetadataForRegionOrCallingCode_(o, n);
            r = this.formatNsn_(r, n, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL);
            n = this.maybeGetFormattedExtension_(e, n, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL);
            return 0 < i.length ? i + ' ' + o + ' ' + r + n : this.prefixNumberWithCountryCallingCode_(o, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL, r, n);
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.formatInOriginalFormat = function (e, t) {
            ...
            switch (e.getCountryCodeSource()) {
              ...
              default:
                var r = this.getRegionCodeForCountryCode(e.getCountryCodeOrDefault()),
                  n = this.getNddPrefixForRegion(r, true);

                if (
                  ((o = this.format(e, i18n.phonenumbers.PhoneNumberFormat.NATIONAL)),
                  null != n &&
                    0 != n.length &&
                    !this.rawInputContainsNationalPrefix_(e.getRawInputOrDefault(), n, r) &&
                    ((r = this.getMetadataForRegion(r)),
                    (n = this.getNationalSignificantNumber(e)),
                    null != (r = this.chooseFormattingPatternForNumber_(r.numberFormatArray(), n))))
                ) {
                  var d = (n = r.getNationalPrefixFormattingRuleOrDefault()).indexOf('$1');

                  if (!(0 >= d)) {
                    n = n.substring(0, d);

                    if (0 != (n = i18n.phonenumbers.PhoneNumberUtil.normalizeDigitsOnly(n)).length) {
                      (o = r.clone()).clearNationalPrefixFormattingRule();
            ...
            if (null != o && 0 < r.length)
              (n = i18n.phonenumbers.PhoneNumberUtil.normalizeDiallableCharsOnly(o)) != (d = i18n.phonenumbers.PhoneNumberUtil.normalizeDiallableCharsOnly(r)) && (o = r);
            return o;
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.hasFormattingPatternForNumber_ = function (e) {
            ...
            return (
              null != (t = this.getMetadataForRegionOrCallingCode_(t, o)) &&
              ((e = this.getNationalSignificantNumber(e)), null != this.chooseFormattingPatternForNumber_(t.numberFormatArray(), e))
            );
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.formatOutOfCountryKeepingAlphaChars = function (e, t) {
            ...
            var r = e.getCountryCodeOrDefault();
            if (!this.hasValidCountryCallingCode_(r)) return o;
            o = i18n.phonenumbers.PhoneNumberUtil.normalizeHelper_(o, i18n.phonenumbers.PhoneNumberUtil.ALL_PLUS_NUMBER_GROUPING_SYMBOLS_, true);
            var n = this.getNationalSignificantNumber(e);

            if (3 < n.length) {
              var d = o.indexOf(n.substring(0, 3));
              if (-1 != d) o = o.substring(d);
            }

            if (((d = this.getMetadataForRegion(t)), r == i18n.phonenumbers.PhoneNumberUtil.NANPA_COUNTRY_CODE_)) {
              if (this.isNANPACountry(t)) return r + ' ' + o;
            } else if (null != d && r == this.getCountryCodeForValidRegion_(t))
              if (null == (r = this.chooseFormattingPatternForNumber_(d.numberFormatArray(), n))) return o;
              else {
                (r = r.clone()).setPattern('(\\d+)(.*)');
                r.setFormat('$1$2');
                return this.formatNsnUsingPattern_(o, r, i18n.phonenumbers.PhoneNumberFormat.NATIONAL);
              }

            n = '';

            if (null != d) {
              n = d.getInternationalPrefixOrDefault();
              n = i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(i18n.phonenumbers.PhoneNumberUtil.SINGLE_INTERNATIONAL_PREFIX_, n)
                ? n
                : d.getPreferredInternationalPrefixOrDefault();
            }

            d = this.getRegionCodeForCountryCode(r);
            d = this.getMetadataForRegionOrCallingCode_(r, d);
            d = this.maybeGetFormattedExtension_(e, d, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL);
            return 0 < n.length ? n + ' ' + r + ' ' + o + d : this.prefixNumberWithCountryCallingCode_(r, i18n.phonenumbers.PhoneNumberFormat.INTERNATIONAL, o, d);
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.getNationalSignificantNumber = function (e) {
            ...
            return e.hasItalianLeadingZero() && e.getItalianLeadingZero() && 0 < e.getNumberOfLeadingZerosOrDefault()
              ? Array(e.getNumberOfLeadingZerosOrDefault() + 1).join('0') + t
              : t;
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.formatNsn_ = function (e, t, o, r) {
            t = 0 == t.intlNumberFormatArray().length || o == i18n.phonenumbers.PhoneNumberFormat.NATIONAL ? t.numberFormatArray() : t.intlNumberFormatArray();
            return null == (t = this.chooseFormattingPatternForNumber_(t, e)) ? e : this.formatNsnUsingPattern_(e, t, o, r);
          };

          i18n.phonenumbers.PhoneNumberUtil.prototype.chooseFormattingPatternForNumber_ = function (e, t) {
            for (var o, r = e.length, n = 0; n < r; ++n) {
              var d = (o = e[n]).leadingDigitsPatternCount();
              if ((0 == d || 0 == t.search(o.getLeadingDigitsPattern(d - 1))) && ((d = new RegExp(o.getPattern())), i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(d, t)))
                return o;
            }
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.formatNsnUsingPattern_ = function (e, t, o, r) {
            var n = t.getFormatOrDefault(),
              d = new RegExp(t.getPattern()),
              i = t.getDomesticCarrierCodeFormattingRuleOrDefault();

            if (o == i18n.phonenumbers.PhoneNumberFormat.NATIONAL && null != r && 0 < r.length && 0 < i.length) {
              t = i.replace(i18n.phonenumbers.PhoneNumberUtil.CC_PATTERN_, r);
              n = n.replace(i18n.phonenumbers.PhoneNumberUtil.FIRST_GROUP_PATTERN_, t);
              e = e.replace(d, n);
            } else {
              t = t.getNationalPrefixFormattingRuleOrDefault();
              e =
                o == i18n.phonenumbers.PhoneNumberFormat.NATIONAL && null != t && 0 < t.length
                  ? e.replace(d, n.replace(i18n.phonenumbers.PhoneNumberUtil.FIRST_GROUP_PATTERN_, t))
                  : e.replace(d, n);
            }

            if (o == i18n.phonenumbers.PhoneNumberFormat.RFC3966)
              e = (e = e.replace(new RegExp('^' + i18n.phonenumbers.PhoneNumberUtil.SEPARATOR_PATTERN_), '')).replace(
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.getExampleNumberForNonGeoEntity = function (e) {
            ...
            if (
              null != t &&
              null !=
                (t = goog.array.find([t.getMobile(), t.getTollFree(), t.getSharedCost(), t.getVoip(), t.getVoicemail(), t.getUan(), t.getPremiumRate()], function (e, t) {
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.maybeGetFormattedExtension_ = function (e, t, o) {
            return e.hasExtension() && 0 != e.getExtension().length
              ? o == i18n.phonenumbers.PhoneNumberFormat.RFC3966
                ? i18n.phonenumbers.PhoneNumberUtil.RFC3966_EXTN_PREFIX_ + e.getExtension()
                : t.hasPreferredExtnPrefix()
                ? t.getPreferredExtnPrefix() + e.getExtensionOrDefault()
                : i18n.phonenumbers.PhoneNumberUtil.DEFAULT_EXTN_PREFIX_ + e.getExtensionOrDefault()
              : '';
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.getNumberType = function (e) {
            ...
            if (null == (t = this.getMetadataForRegionOrCallingCode_(e.getCountryCodeOrDefault(), t))) return i18n.phonenumbers.PhoneNumberType.UNKNOWN;
            else {
              e = this.getNationalSignificantNumber(e);
              return this.getNumberTypeHelper_(e, t);
            }
          };

          i18n.phonenumbers.PhoneNumberUtil.prototype.getNumberTypeHelper_ = function (e, t) {
            return this.isNumberMatchingDesc_(e, t.getGeneralDesc())
              ? this.isNumberMatchingDesc_(e, t.getPremiumRate())
                ? i18n.phonenumbers.PhoneNumberType.PREMIUM_RATE
                : this.isNumberMatchingDesc_(e, t.getTollFree())
                ? i18n.phonenumbers.PhoneNumberType.TOLL_FREE
                : this.isNumberMatchingDesc_(e, t.getSharedCost())
                ? i18n.phonenumbers.PhoneNumberType.SHARED_COST
                : this.isNumberMatchingDesc_(e, t.getVoip())
                ? i18n.phonenumbers.PhoneNumberType.VOIP
                : this.isNumberMatchingDesc_(e, t.getPersonalNumber())
                ? i18n.phonenumbers.PhoneNumberType.PERSONAL_NUMBER
                : this.isNumberMatchingDesc_(e, t.getPager())
                ? i18n.phonenumbers.PhoneNumberType.PAGER
                : this.isNumberMatchingDesc_(e, t.getUan())
                ? i18n.phonenumbers.PhoneNumberType.UAN
                : this.isNumberMatchingDesc_(e, t.getVoicemail())
                ? i18n.phonenumbers.PhoneNumberType.VOICEMAIL
                : this.isNumberMatchingDesc_(e, t.getFixedLine())
                ? t.getSameMobileAndFixedLinePattern() || this.isNumberMatchingDesc_(e, t.getMobile())
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.getMetadataForRegion = function (e) {
            ...
            if (null == t) {
              ...
              t = t.deserialize(i18n.phonenumbers.PhoneMetadata.getDescriptor(), o);
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.isNumberMatchingDesc_ = function (e, t) {
            var o = e.length;
            return (
              !(0 < t.possibleLengthCount() && -1 == goog.array.indexOf(t.possibleLengthArray(), o)) &&
              i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(t.getNationalNumberPatternOrDefault(), e)
            );
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.isValidNumberForRegion = function (e, t) {
            var o = e.getCountryCodeOrDefault(),
              r = this.getMetadataForRegionOrCallingCode_(o, t);
            return (
              null != r &&
              (i18n.phonenumbers.PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY == t || o == this.getCountryCodeForValidRegion_(t)) &&
              ((o = this.getNationalSignificantNumber(e)), this.getNumberTypeHelper_(o, r) != i18n.phonenumbers.PhoneNumberType.UNKNOWN)
            );
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.getRegionCodeForNumberFromRegionList_ = function (e, t) {
            for (var o, r = this.getNationalSignificantNumber(e), n = t.length, d = 0; d < n; d++) {
              o = t[d];
              var i = this.getMetadataForRegion(o);

              if (i.hasLeadingDigits()) {
                if (0 == r.search(i.getLeadingDigits())) return o;
              } else if (this.getNumberTypeHelper_(r, i) != i18n.phonenumbers.PhoneNumberType.UNKNOWN) return o;
            }
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.isAlphaNumber = function (e) {
            return (
              !!i18n.phonenumbers.PhoneNumberUtil.isViablePhoneNumber(e) &&
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.isPossibleNumber = function (e) {
            return (
              (e = this.isPossibleNumberWithReason(e)) == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.IS_POSSIBLE ||
              e == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.IS_POSSIBLE_LOCAL_ONLY
            );
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.testNumberLengthForType_ = function (e, t, o) {
            var r = i18n.phonenumbers.PhoneNumberUtil.getNumberDescByType_(t, o),
              n = 0 == r.possibleLengthCount() ? t.getGeneralDesc().possibleLengthArray() : r.possibleLengthArray();

            if (((r = r.possibleLengthLocalOnlyArray()), o == i18n.phonenumbers.PhoneNumberType.FIXED_LINE_OR_MOBILE)) {
              if (
                !i18n.phonenumbers.PhoneNumberUtil.descHasPossibleNumberData_(
                  i18n.phonenumbers.PhoneNumberUtil.getNumberDescByType_(t, i18n.phonenumbers.PhoneNumberType.FIXED_LINE)
                )
              )
                return this.testNumberLengthForType_(e, t, i18n.phonenumbers.PhoneNumberType.MOBILE);
              o = i18n.phonenumbers.PhoneNumberUtil.getNumberDescByType_(t, i18n.phonenumbers.PhoneNumberType.MOBILE);

              if (i18n.phonenumbers.PhoneNumberUtil.descHasPossibleNumberData_(o)) {
                n = n.concat(0 == o.possibleLengthCount() ? t.getGeneralDesc().possibleLengthArray() : o.possibleLengthArray());
                goog.array.sort(n);
                if (0 == r.length) r = o.possibleLengthLocalOnlyArray();
                else {
                  r = r.concat(o.possibleLengthLocalOnlyArray());
                  goog.array.sort(r);
                }
              }
            }

            if (-1 == n[0]) return i18n.phonenumbers.PhoneNumberUtil.ValidationResult.INVALID_LENGTH;
            else {
              e = e.length;
              return -1 < goog.array.indexOf(r, e)
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.isPossibleNumberForTypeWithReason = function (e, t) {
            var o = this.getNationalSignificantNumber(e),
              r = e.getCountryCodeOrDefault();
            if (!this.hasValidCountryCallingCode_(r)) return i18n.phonenumbers.PhoneNumberUtil.ValidationResult.INVALID_COUNTRY_CODE;
            var n = this.getRegionCodeForCountryCode(r);
            r = this.getMetadataForRegionOrCallingCode_(r, n);
            return this.testNumberLengthForType_(o, r, t);
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.truncateTooLongNumber = function (e) {
            if (this.isValidNumber(e)) return true;
            var t = e.clone(),
              o = e.getNationalNumberOrDefault();

            do {
              if (((o = Math.floor(o / 10)), t.setNationalNumber(o), 0 == o || this.isPossibleNumberWithReason(t) == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.TOO_SHORT))
                return false;
            } while (!this.isValidNumber(t));

            e.setNationalNumber(o);
            return true;
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.extractCountryCode = function (e, t) {
            ...
            for (var r, n = o.length, d = 1; d <= i18n.phonenumbers.PhoneNumberUtil.MAX_LENGTH_COUNTRY_CODE_ && d <= n; ++d)
              if ((r = parseInt(o.substring(0, d), 10)) in i18n.phonenumbers.metadata.countryCodeToRegionCodeMap) {
                t.append(o.substring(d));
                return r;
              }
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.maybeExtractCountryCode = function (e, t, o, r, n) {
            ...
            if (
              ((e = new goog.string.StringBuffer(e)),
              null != t && (d = t.getInternationalPrefix()),
              null == d && (d = 'NonMatch'),
              ...
              if (0 != (t = this.extractCountryCode(e, o))) {
                n.setCountryCode(t);
                return t;
              }
            ...
            if (null != t) {
              ...
              if (
                goog.string.startsWith(a, i) &&
                ((i = new goog.string.StringBuffer(a.substring(i.length))),
                (a = t.getGeneralDesc()),
                (a = new RegExp(a.getNationalNumberPatternOrDefault())),
                this.maybeStripNationalPrefixAndCarrierCode(i, t, null),
                (i = i.toString()),
                (!i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(a, e.toString()) && i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(a, i)) ||
                  this.testNumberLength_(e.toString(), t) == i18n.phonenumbers.PhoneNumberUtil.ValidationResult.TOO_LONG)
              ) {
                o.append(i);
                if (r) n.setCountryCodeSource(i18n.phonenumbers.PhoneNumber.CountryCodeSource.FROM_NUMBER_WITHOUT_PLUS_SIGN);
                n.setCountryCode(d);
                return d;
              }
            }
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.parsePrefixAsIdd_ = function (e, t) {
            ...
            if (0 == o.search(e)) {
              var r = o.match(e)[0].length,
                n = o.substring(r).match(i18n.phonenumbers.PhoneNumberUtil.CAPTURING_DIGIT_PATTERN);
              return !(n && null != n[1] && 0 < n[1].length && '0' == i18n.phonenumbers.PhoneNumberUtil.normalizeDigitsOnly(n[1])) && (t.clear(), t.append(o.substring(r)), true);
            }
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.maybeStripInternationalPrefixAndNormalize = function (e, t) {
            ...
            return 0 == o.length
              ...
              : i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN.test(o)
              ? ((o = o.replace(i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN, '')),
                e.clear(),
                e.append(i18n.phonenumbers.PhoneNumberUtil.normalize(o)),
                i18n.phonenumbers.PhoneNumber.CountryCodeSource.FROM_NUMBER_WITH_PLUS_SIGN)
              : ((o = new RegExp(t)),
                i18n.phonenumbers.PhoneNumberUtil.normalizeSB_(e),
                this.parsePrefixAsIdd_(o, e)
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.maybeStripNationalPrefixAndCarrierCode = function (e, t, o) {
            ...
            if (0 == n || null == d || 0 == d.length) return false;
            var i = new RegExp('^(?:' + d + ')');

            if ((n = i.exec(r))) {
              d = new RegExp(t.getGeneralDesc().getNationalNumberPatternOrDefault());
              var a = i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(d, r),
                g = n.length - 1;

              if (null == (t = t.getNationalPrefixTransformRule()) || 0 == t.length || null == n[g] || 0 == n[g].length) {
                if (a && !i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(d, r.substring(n[0].length))) return false;
                if (null != o && 0 < g && null != n[g]) o.append(n[1]);
                e.set(r.substring(n[0].length));
              } else {
                if (((r = r.replace(i, t)), a && !i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(d, r))) return false;
                if (null != o && 0 < g) o.append(n[1]);
                e.set(r);
              }
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.parse = function (e, t) {
            return this.parseHelper_(e, t, false, true);
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.parseHelper_ = function (e, t, o, r) {
            ...
            if (r && !this.checkRegionForParsing_(n.toString(), t)) throw Error(i18n.phonenumbers.Error.INVALID_COUNTRY_CODE);
            r = new i18n.phonenumbers.PhoneNumber();
            if (o) r.setRawInput(e);
            if (0 < (e = this.maybeStripExtension(n)).length) r.setExtension(e);
            ...
            try {
              i = this.maybeExtractCountryCode(a, d, e, o, r);
            } catch (t) {
              ...
              if (((a = a.replace(i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN, '')), 0 == (i = this.maybeExtractCountryCode(a, d, e, o, r)))) throw t;
            }

            if (
              (0 != i
                ? (n = this.getRegionCodeForCountryCode(i)) != t && (d = this.getMetadataForRegionOrCallingCode_(i, n))
                : (i18n.phonenumbers.PhoneNumberUtil.normalizeSB_(n),
                  e.append(n.toString()),
                  null != t ? ((i = d.getCountryCodeOrDefault()), r.setCountryCode(i)) : o && r.clearCountryCodeSource()),
              e.getLength() < i18n.phonenumbers.PhoneNumberUtil.MIN_LENGTH_FOR_NSN_)
            )
              throw Error(i18n.phonenumbers.Error.TOO_SHORT_NSN);
            if (
              (null != d &&
                ((t = new goog.string.StringBuffer()),
                (n = new goog.string.StringBuffer(e.toString())),
                this.maybeStripNationalPrefixAndCarrierCode(n, d, t),
                (d = this.testNumberLength_(n.toString(), d)) != (i = i18n.phonenumbers.PhoneNumberUtil.ValidationResult).TOO_SHORT &&
                  d != i.IS_POSSIBLE_LOCAL_ONLY &&
                  d != i.INVALID_LENGTH &&
                  ((e = n), o && 0 < t.toString().length && r.setPreferredDomesticCarrierCode(t.toString()))),
              (e = (o = e.toString()).length) < i18n.phonenumbers.PhoneNumberUtil.MIN_LENGTH_FOR_NSN_)
            )
              throw Error(i18n.phonenumbers.Error.TOO_SHORT_NSN);
            if (e > i18n.phonenumbers.PhoneNumberUtil.MAX_LENGTH_FOR_NSN_) throw Error(i18n.phonenumbers.Error.TOO_LONG);
            i18n.phonenumbers.PhoneNumberUtil.setItalianLeadingZerosForPhoneNumber_(o, r);
            r.setNationalNumber(parseInt(o, 10));
            return r;
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.buildNationalNumberForParsing_ = function (e, t) {
            ...
            if (0 <= o) {
              ...
              if (e.charAt(r) == i18n.phonenumbers.PhoneNumberUtil.PLUS_SIGN) {
                var n = e.indexOf(';', r);
                if (0 < n) t.append(e.substring(r, n));
                else t.append(e.substring(r));
              }

              r = e.indexOf(i18n.phonenumbers.PhoneNumberUtil.RFC3966_PREFIX_);
              t.append(e.substring(0 <= r ? r + i18n.phonenumbers.PhoneNumberUtil.RFC3966_PREFIX_.length : 0, o));
            } else t.append(i18n.phonenumbers.PhoneNumberUtil.extractPossibleNumber(e));

            if (0 < (r = (o = t.toString()).indexOf(i18n.phonenumbers.PhoneNumberUtil.RFC3966_ISDN_SUBADDRESS_))) {
              t.clear();
              t.append(o.substring(0, r));
            }
          };

          i18n.phonenumbers.PhoneNumberUtil.copyCoreFieldsOnly_ = function (e) {
            var t = new i18n.phonenumbers.PhoneNumber();
            t.setCountryCode(e.getCountryCodeOrDefault());
            t.setNationalNumber(e.getNationalNumberOrDefault());
            if (0 < e.getExtensionOrDefault().length) t.setExtension(e.getExtensionOrDefault());

            if (e.getItalianLeadingZero()) {
              t.setItalianLeadingZero(true);
              t.setNumberOfLeadingZeros(e.getNumberOfLeadingZerosOrDefault());
            }
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.isNumberMatch = function (e, t) {
            if ('string' == typeof e)
              try {
                ...
                if (n.message != i18n.phonenumbers.Error.INVALID_COUNTRY_CODE) return i18n.phonenumbers.PhoneNumberUtil.MatchType.NOT_A_NUMBER;
                ...
                try {
                  o = this.parseHelper_(e, null, false, false);
                } catch (e) {
                  return i18n.phonenumbers.PhoneNumberUtil.MatchType.NOT_A_NUMBER;
                }
              }
            ...
            if ('string' == typeof t)
              try {
                var n = this.parse(t, i18n.phonenumbers.PhoneNumberUtil.UNKNOWN_REGION_);
                return this.isNumberMatch(e, n);
              } catch (e) {
            ...
            if (
              ((o = i18n.phonenumbers.PhoneNumberUtil.copyCoreFieldsOnly_(o)),
              (n = i18n.phonenumbers.PhoneNumberUtil.copyCoreFieldsOnly_(n)),
              o.hasExtension() && n.hasExtension() && o.getExtension() != n.getExtension())
            )
              return i18n.phonenumbers.PhoneNumberUtil.MatchType.NO_MATCH;
            r = o.getCountryCodeOrDefault();
            var d = n.getCountryCodeOrDefault();
            if (0 != r && 0 != d)
              return o.equals(n)
                ? i18n.phonenumbers.PhoneNumberUtil.MatchType.EXACT_MATCH
                : r == d && this.isNationalNumberSuffixOfTheOther_(o, n)
              ...
              return o.equals(n)
                ...
                : this.isNationalNumberSuffixOfTheOther_(o, n)
                ? i18n.phonenumbers.PhoneNumberUtil.MatchType.SHORT_NSN_MATCH
                : i18n.phonenumbers.PhoneNumberUtil.MatchType.NO_MATCH;
            }
          };
          ...
          i18n.phonenumbers.PhoneNumberUtil.prototype.isNationalNumberSuffixOfTheOther_ = function (e, t) {
            var o = '' + e.getNationalNumber(),
              r = '' + t.getNationalNumber();
            return goog.string.endsWith(o, r) || goog.string.endsWith(r, o);
          };
          ...
          i18n.phonenumbers.AsYouTypeFormatter.ELIGIBLE_FORMAT_PATTERN_ = new RegExp(
            '^[' + i18n.phonenumbers.PhoneNumberUtil.VALID_PUNCTUATION + ']*(\\$\\d[' + i18n.phonenumbers.PhoneNumberUtil.VALID_PUNCTUATION + ']*)+$'
          );
          i18n.phonenumbers.AsYouTypeFormatter.NATIONAL_PREFIX_SEPARATORS_PATTERN_ = /[- ]/;
          i18n.phonenumbers.AsYouTypeFormatter.MIN_LEADING_DIGITS_LENGTH_ = 3;

          i18n.phonenumbers.AsYouTypeFormatter.prototype.getMetadataForRegion_ = function (e) {
            e = this.phoneUtil_.getCountryCodeForRegion(e);
            e = this.phoneUtil_.getRegionCodeForCountryCode(e);
            return null != (e = this.phoneUtil_.getMetadataForRegion(e)) ? e : i18n.phonenumbers.AsYouTypeFormatter.EMPTY_METADATA_;
          };
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.maybeCreateNewTemplate_ = function () {
            for (var e = this.possibleFormats_.length, t = 0; t < e; ++t) {
              ...
              if (this.currentFormattingPattern_ == r) return false;

              if (this.createFormattingTemplate_(o)) {
                this.currentFormattingPattern_ = r;
                this.shouldAddSpaceAfterNationalPrefix_ = i18n.phonenumbers.AsYouTypeFormatter.NATIONAL_PREFIX_SEPARATORS_PATTERN_.test(o.getNationalPrefixFormattingRule());
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.getAvailableFormats_ = function (e) {
            for (
              var t =
                  this.isCompleteNumber_ && 0 == this.extractedNationalPrefix_.length && 0 < this.currentMetadata_.intlNumberFormatCount()
              ...
              if (
                !(
                  0 < this.extractedNationalPrefix_.length &&
                  this.phoneUtil_.formattingRuleHasFirstGroupOnly(n.getNationalPrefixFormattingRuleOrDefault()) &&
                  !n.getNationalPrefixOptionalWhenFormatting() &&
                  !n.hasDomesticCarrierCodeFormattingRule()
                )
              )
                (0 != this.extractedNationalPrefix_.length ||
                  ...
                  this.phoneUtil_.formattingRuleHasFirstGroupOnly(n.getNationalPrefixFormattingRuleOrDefault()) ||
                  n.getNationalPrefixOptionalWhenFormatting()) &&
                  i18n.phonenumbers.AsYouTypeFormatter.ELIGIBLE_FORMAT_PATTERN_.test(n.getFormatOrDefault()) &&
                  this.possibleFormats_.push(n);
            }
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.narrowDownPossibleFormats_ = function (e) {
            for (var t = [], o = e.length - i18n.phonenumbers.AsYouTypeFormatter.MIN_LEADING_DIGITS_LENGTH_, r = this.possibleFormats_.length, n = 0; n < r; ++n) {
              ...
              if (0 == d.leadingDigitsPatternCount()) t.push(this.possibleFormats_[n]);
              else {
                var i = o ** (d.leadingDigitsPatternCount() - 1);
                d = d.getLeadingDigitsPattern(i);
                if (0 == e.search(d)) t.push(this.possibleFormats_[n]);
              }
            }
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.createFormattingTemplate_ = function (e) {
            ...
            return 0 < (e = this.getFormattingTemplate_(t, e.getFormatOrDefault())).length && (this.formattingTemplate_.append(e), true);
          };

          i18n.phonenumbers.AsYouTypeFormatter.prototype.getFormattingTemplate_ = function (e, t) {
            var o = '999999999999999'.match(e)[0];
            return o.length < this.nationalNumber_.getLength() ? '' : (o = o.replace(new RegExp(e, 'g'), t)).replace(RegExp('9', 'g'), this.DIGIT_PLACEHOLDER_);
          };
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.clear = function () {
            ...
            this.possibleFormats_ = [];
            this.shouldAddSpaceAfterNationalPrefix_ = false;
            if (this.currentMetadata_ != this.defaultMetadata_) this.currentMetadata_ = this.getMetadataForRegion_(this.defaultCountry_);
          };

          i18n.phonenumbers.AsYouTypeFormatter.prototype.inputDigit = function (e) {
            return (this.currentOutput_ = this.inputDigitWithOptionToRememberPosition_(e, false));
          };

          i18n.phonenumbers.AsYouTypeFormatter.prototype.inputDigitAndRememberPosition = function (e) {
            return (this.currentOutput_ = this.inputDigitWithOptionToRememberPosition_(e, true));
          };

          i18n.phonenumbers.AsYouTypeFormatter.prototype.inputDigitWithOptionToRememberPosition_ = function (e, t) {
            if (
              (this.accruedInput_.append(e),
              t && (this.originalPosition_ = this.accruedInput_.getLength()),
              this.isDigitOrLeadingPlusSign_(e) ? (e = this.normalizeAndAccrueDigitsAndPlusSign_(e, t)) : ((this.ableToFormat_ = false), (this.inputHasFormatting_ = true)),
              !this.ableToFormat_)
            ) {
            ...
            switch (this.accruedInputWithoutFormatting_.getLength()) {
              ...
              default:
                if (this.isExpectingCountryCallingCode_) {
                  if (this.attemptToExtractCountryCallingCode_()) this.isExpectingCountryCallingCode_ = false;
                  return this.prefixBeforeNationalNumber_.toString() + this.nationalNumber_.toString();
                }

                if (0 < this.possibleFormats_.length) {
                  var o = this.inputDigitHelper_(e),
                    r = this.attemptToFormatAccruedDigits_();
                  if (0 < r.length) return r;
                  else {
                    this.narrowDownPossibleFormats_(this.nationalNumber_.toString());
                    return this.maybeCreateNewTemplate_() ? this.inputAccruedNationalNumber_() : this.ableToFormat_ ? this.appendNationalNumber_(o) : this.accruedInput_.toString();
                  }
                }
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.isDigitOrLeadingPlusSign_ = function (e) {
            return (
              i18n.phonenumbers.PhoneNumberUtil.CAPTURING_DIGIT_PATTERN.test(e) ||
              (1 == this.accruedInput_.getLength() && i18n.phonenumbers.PhoneNumberUtil.PLUS_CHARS_PATTERN.test(e))
            );
          };

          i18n.phonenumbers.AsYouTypeFormatter.prototype.attemptToFormatAccruedDigits_ = function () {
            for (var e = this.nationalNumber_.toString(), t = this.possibleFormats_.length, o = 0; o < t; ++o) {
              var r = this.possibleFormats_[o],
                n = r.getPatternOrDefault();
              if (
                new RegExp('^(?:' + n + ')$').test(e) &&
                ((this.shouldAddSpaceAfterNationalPrefix_ = i18n.phonenumbers.AsYouTypeFormatter.NATIONAL_PREFIX_SEPARATORS_PATTERN_.test(r.getNationalPrefixFormattingRule())),
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.appendNationalNumber_ = function (e) {
            ...
            return this.shouldAddSpaceAfterNationalPrefix_ &&
              0 < t &&
              this.prefixBeforeNationalNumber_.toString().charAt(t - 1) != i18n.phonenumbers.AsYouTypeFormatter.SEPARATOR_BEFORE_NATIONAL_NUMBER_
              ? this.prefixBeforeNationalNumber_ + i18n.phonenumbers.AsYouTypeFormatter.SEPARATOR_BEFORE_NATIONAL_NUMBER_ + e
              : this.prefixBeforeNationalNumber_ + e;
          };
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.attemptToChooseFormattingPattern_ = function () {
            ...
            if (e.length >= i18n.phonenumbers.AsYouTypeFormatter.MIN_LEADING_DIGITS_LENGTH_) {
              this.getAvailableFormats_(e);
              return 0 < (e = this.attemptToFormatAccruedDigits_()).length
                ? e
                : this.maybeCreateNewTemplate_()
                ? this.inputAccruedNationalNumber_()
                : this.accruedInput_.toString();
            } else return this.appendNationalNumber_(e);
          };
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.inputAccruedNationalNumber_ = function () {
            ...
            if (0 < t) {
              for (var o = '', r = 0; r < t; r++) o = this.inputDigitHelper_(e.charAt(r));
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.removeNationalPrefixFromNationalNumber_ = function () {
            ...
            if (this.isNanpaNumberWithNationalPrefix_()) {
              ...
              if (null != (o = e.match(o)) && null != o[0] && 0 < o[0].length) {
                this.isCompleteNumber_ = true;
                t = o[0].length;
                this.prefixBeforeNationalNumber_.append(e.substring(0, t));
              }
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.attemptToExtractIdd_ = function () {
            ...
            return (
              ...
              this.prefixBeforeNationalNumber_.clear(),
              this.prefixBeforeNationalNumber_.append(e.substring(0, t)),
              e.charAt(0) != i18n.phonenumbers.PhoneNumberUtil.PLUS_SIGN &&
                this.prefixBeforeNationalNumber_.append(i18n.phonenumbers.AsYouTypeFormatter.SEPARATOR_BEFORE_NATIONAL_NUMBER_),
              true)
            );
          };
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.attemptToExtractCountryCallingCode_ = function () {
            ...
            return (
              ...
              i18n.phonenumbers.PhoneNumberUtil.REGION_CODE_FOR_NON_GEO_ENTITY == e
                ? (this.currentMetadata_ = this.phoneUtil_.getMetadataForNonGeographicalRegion(t))
                : e != this.defaultCountry_ && (this.currentMetadata_ = this.getMetadataForRegion_(e)),
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.normalizeAndAccrueDigitsAndPlusSign_ = function (e, t) {
            if (e == i18n.phonenumbers.PhoneNumberUtil.PLUS_SIGN) {
              ...
              o = i18n.phonenumbers.PhoneNumberUtil.DIGIT_MAPPINGS[e];
              this.accruedInputWithoutFormatting_.append(o);
              this.nationalNumber_.append(o);
            }

            if (t) this.positionToRemember_ = this.accruedInputWithoutFormatting_.getLength();
            return o;
          };
          ...
          i18n.phonenumbers.AsYouTypeFormatter.prototype.inputDigitHelper_ = function (e) {
            ...
            if (1 == this.possibleFormats_.length) this.ableToFormat_ = false;
            this.currentFormattingPattern_ = '';
            return this.accruedInput_.toString();
          };
          ...
          i18n.phonenumbers.shortnumbermetadata.countryToMetadata = {
            ...
            BE: [
              ...
              [
                ,
                ,
                '1(?:0[0-8]|1(?:[027]|6117)|2(?:12|3[0-24])|313|414|5(?:1[05]|5[15]|66|95)|6(?:1[167]|36|6[16])|7(?:[07][017]|1[27-9]|22|33|65)|81[39])|[2-9]\\d{3}|1(?:1600|45)0|1(?:[2-4]9|78)9|1[2-4]0[47]',
                ,
                ,
                ,
                '100',
            ...
            ER: [
              ...
              ,
              ,
              [, , '1(?:1[2-46]|24422)|20(?:1(?:606|917)|2914)|(?:1277|2020)99', , , , '112'],
              ,
            ...
            GB: [
              ...
              [
                ,
                ,
                '1(?:0[015]|1(?:[12]|6(?:000|1(?:11|23))|8\\d{3})|2(?:[1-3]|50)|33|4(?:1|7\\d)|571|7(?:0\\d|[56]0)|800\\d|9[15])|2(?:0202|1300|2(?:02|11)|3(?:02|336|45)|4(?:25|8))|3[13]3|4(?:0[02]|35[01]|44[45]|5\\d)|(?:[68]\\d|7[089])\\d{3}|15\\d|2[02]2|650|789|9(?:01|99)',
                ,
                ,
                ,
                '100',
            ...
            TH: [
              ...
              [
                ,
                ,
                '1(?:0[0-2]|1(?:0[03]|1[1-35]|2[0358]|3[03-79]|4[02-489]|5[04-9]|6[04-79]|7[03-9]|8[027-9]|9[02-79])|2(?:22|3[89]|66)|3(?:18|2[23]|3[013]|5[56]|6[45]|73)|477|5(?:0\\d|4[0-37-9]|5[1-8]|6[01679]|7[12568]|8[0-24589]|9[013589])|6(?:0[0-29]|2[03]|4[3-6]|6[1-9]|7[0257-9]|8[0158]|9[014-9])|7(?:[14]9|7[27]|90)|888|9[19])',
                ,
                ,
                ,
                '100',
              ...
              [
                ,
                ,
                '1(?:1(?:03|1[15]|2[58]|3[056]|4[02-49]|5[046-9]|7[03-589]|9[579])|5(?:0[0-8]|4[0-378]|5[1-478]|7[156])|6(?:20|4[356]|6[1-68]|7[057-9]|8[015]|9[0457-9]))|1(?:1[68]|26|3[1-35]|5[689]|60|7[17])\\d',
                ,
                ,
                ,
                '1103',
          ...
          i18n.phonenumbers.ShortNumberInfo.prototype.isPossibleShortNumberForRegion = function (e, t) {
            if (!this.regionDialingFromMatchesNumber_(e, t)) return false;
            var o = this.getMetadataForRegion_(t);
            if (!o) return false;
            var r = this.getNationalSignificantNumber_(e).length;
            return goog.array.contains(o.getGeneralDesc().possibleLengthArray(), r);
          };
          ...
          i18n.phonenumbers.ShortNumberInfo.prototype.isPossibleShortNumber = function (e) {
            ...
            for (var o = 0; o < t.length; o++) {
              ...
              if (r && ((r = r.getGeneralDesc().possibleLengthArray()), goog.array.contains(r, e))) return true;
            }
          ...
          i18n.phonenumbers.ShortNumberInfo.prototype.isValidShortNumberForRegion = function (e, t) {
            ...
            var r = this.getNationalSignificantNumber_(e),
              n = o.getGeneralDesc();
            return !!this.matchesPossibleNumberAndNationalNumber_(r, n) && ((o = o.getShortCode()), this.matchesPossibleNumberAndNationalNumber_(r, o));
          };
          ...
          i18n.phonenumbers.ShortNumberInfo.prototype.getExpectedCostForRegion = function (e, t) {
            ...
            if (!r) return o.UNKNOWN_COST;
            var n = this.getNationalSignificantNumber_(e);
            return goog.array.contains(r.getGeneralDesc().possibleLengthArray(), n.length)
              ? this.matchesPossibleNumberAndNationalNumber_(n, r.getPremiumRate())
                ? o.PREMIUM_RATE
                : this.matchesPossibleNumberAndNationalNumber_(n, r.getStandardRate())
                ? o.STANDARD_RATE
                : this.matchesPossibleNumberAndNationalNumber_(n, r.getTollFree()) || this.isEmergencyNumber(n, t)
                ? o.TOLL_FREE
                : o.UNKNOWN_COST
              : o.UNKNOWN_COST;
          };
            ...
            for (var r = t.TOLL_FREE, n = 0; n < o.length; n++) {
              ...
              switch (d) {
                ...
                case t.STANDARD_RATE:
                  if (r !== t.UNKNOWN_COST) r = t.STANDARD_RATE;
                  break;
          ...
          i18n.phonenumbers.ShortNumberInfo.prototype.getRegionCodeForShortNumberFromRegionList_ = function (e, t) {
            ...
            for (var o = this.getNationalSignificantNumber_(e), r = 0; r < t.length; r++) {
              var n = t[r],
                d = this.getMetadataForRegion_(n);
              if (d && this.matchesPossibleNumberAndNationalNumber_(o, d.getShortCode())) return n;
            }
          ...
          i18n.phonenumbers.ShortNumberInfo.prototype.getExampleShortNumberForCost = function (e, t) {
            ...
            if (!o) return '';
            var r = i18n.phonenumbers.ShortNumberInfo.ShortNumberCost,
              n = null;
          ...
          i18n.phonenumbers.ShortNumberInfo.prototype.matchesEmergencyNumberHelper_ = function (e, t, o) {
            ...
            return (
              !i18n.phonenumbers.PhoneNumberUtil.LEADING_PLUS_CHARS_PATTERN.test(r) &&
              !(null == (e = this.getMetadataForRegion_(t)) || !e.hasEmergency()) &&
              ((r = i18n.phonenumbers.PhoneNumberUtil.normalizeDigitsOnly(r)),
              (t = o && !goog.array.contains(i18n.phonenumbers.ShortNumberInfo.REGIONS_WHERE_EMERGENCY_NUMBERS_MUST_BE_EXACT_, t)),
              (o = e.getEmergency().getNationalNumberPatternOrDefault()),
              i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(o, r) || (t && i18n.phonenumbers.PhoneNumberUtil.matchesPrefix(o, r)))
            );
          };

          i18n.phonenumbers.ShortNumberInfo.prototype.isCarrierSpecific = function (e) {
            var t = this.getRegionCodesForCountryCode_(e.getCountryCodeOrDefault());
            t = this.getRegionCodeForShortNumberFromRegionList_(e, t);
            e = this.getNationalSignificantNumber_(e);
            return !!(t = this.getMetadataForRegion_(t)) && this.matchesPossibleNumberAndNationalNumber_(e, t.getCarrierSpecific());
          };
          ...
          i18n.phonenumbers.ShortNumberInfo.prototype.isCarrierSpecificForRegion = function (e, t) {
            ...
            var o = this.getNationalSignificantNumber_(e),
              r = this.getMetadataForRegion_(t);
            return !!r && this.matchesPossibleNumberAndNationalNumber_(o, r.getCarrierSpecific());
          };

          i18n.phonenumbers.ShortNumberInfo.prototype.isSmsServiceForRegion = function (e, t) {
            if (!this.regionDialingFromMatchesNumber_(e, t)) return false;
            var o = this.getMetadataForRegion_(t),
              r = this.getNationalSignificantNumber_(e);
            return !!o && this.matchesPossibleNumberAndNationalNumber_(r, o.getSmsServices());
          };
          ...
          i18n.phonenumbers.ShortNumberInfo.prototype.matchesPossibleNumberAndNationalNumber_ = function (e, t) {
            return (
              !(0 < t.possibleLengthArray().length && !goog.array.contains(t.possibleLengthArray(), e.length)) &&
              i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(t.getNationalNumberPatternOrDefault(), e.toString())
            );
          };
